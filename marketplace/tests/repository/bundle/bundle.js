...
import { copyFile }  from 'helpers/utils';
...
import BundleRepository from 'repositories/bundle.js';
...
describe('bundle', () => {
  ...
  let oFakeLogoId = null;
  let oFakeNewResource = null;
  let oFakeResource1 = null;
  let oFakeResource2 = null;
  let oFakeResource3 = null;
  ...
  before(' Set vars and create the repos  ', () => {
    ...
    oUtils.copyFile('tests\\helpers\\resources\\original\\img1.png', 'tests\\helpers\\resources\\img1.png');
    oFakeResource1 = {
      id_item: null,
      file:{
        fieldname: 'resource',
        ...
        destination: 'public/uploads/',
        filename: 'img1',
        path: 'tests\\helpers\\resources\\img1.png',
        size: 5855
      },
      options: 'main_picture',
    };

    oUtils.copyFile('tests\\helpers\\resources\\original\\img3.jpg', 'tests\\helpers\\resources\\img3.jpg');
    oFakeResource2 = {
      id_item: null,
      file:{
        fieldname: 'resource',
        ...
        destination: 'public/uploads/',
        filename: 'img3',
        path: 'tests\\helpers\\resources\\img3.jpg',
        size: 5855
      },
      options: 'main_picture',
    };

    oUtils.copyFile('tests\\helpers\\resources\\original\\video1.mp4', 'tests\\helpers\\resources\\video1.mp4');
    oFakeResource3 = {
      id_item: null,
      file:{
        fieldname: 'resource',
        ...
        destination: 'public/uploads/',
        filename: 'video1',
        path: 'tests\\helpers\\resources\\video1.mp4',
        size: 5855
      },
      options: 'main_picture',
    };
