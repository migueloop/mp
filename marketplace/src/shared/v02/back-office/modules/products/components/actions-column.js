...
class ActionsColumn extends Components {
  ...
  render() {
    ...
    const userLogged = !!this.props.user.get('id');
    ...
    return (
      <div className="mp-sidebar">
        ...
        <div className="feedback">
          ...
          {/* Like button */}
          <Link to="#like" onClick={evt => evt.preventDefault()} className={`btn-like like ${!!userLogged ? 'hidden' : 'none'}`} >
        ...
        <div className="actions">
            {
              userLogged && <AssignButton user={this.props.user} product={this.props.product} />
            }
