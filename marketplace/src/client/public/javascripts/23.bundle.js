...
/***/ function(module, exports, __webpack_require__) {
	...
	var _axios = __webpack_require__(518);
	...
	var _comment = __webpack_require__(482);
	...
	var ModalTimeLine = (_temp = _class = function (_Components) {
	  _inherits(ModalTimeLine, _Components);
	
	  function ModalTimeLine(props) {
	    _classCallCheck(this, ModalTimeLine);
	
	    var _this = _possibleConstructorReturn(this, (ModalTimeLine.__proto__ || Object.getPrototypeOf(ModalTimeLine)).call(this, props));
	
	    _this.onChangeComment = function (e) {
	      return _this.setState({ comment: e.target.value });
	    };
	
	    _this.onSubmitComment = function () {
	      var comment = _this.state.comment;
	      if (!_this.isCommentValid(comment)) {
	        return _this.props.notification.add({ message: _this.format({ id: 'invalid_comment' }), level: 'error' });
	      }
	      var payload = {
	        body: comment,
	        userId: _this.props.user.toJS().id,
	        workflowId: _this.props.workflowId
	      };
	
	      return new _actions2.default(_this.props.tenant).LogComments.create(payload).then(function (action) {
	        return _this.props.dispatch(action);
	      }).then(function () {
	        return _this.setState({ comment: '' });
	      }).then(function () {
	        return _this.props.notification.add({ message: _this.format({ id: 'comment_added' }), level: 'success' });
	      });
	    };
	
	    _this.isCommentValid = function (comment) {
	      if (!comment || comment === '') {
	        return false;
	      }
	      return true;
	    ...
	    _this.getLogsAndCommentsMarkup = function (logs, comments) {
	      var users = _this.props.users.toJS();
	      // TODO - match agains workflow id - need this from log ajax call!
	      var logsAndComments = logs.concat(comments).map(function (item) {
	        var copy = _extends(item);
	        if (copy.body) {
	          copy.type = 'comment';
	          copy.date = copy.created_at;
	          copy.user = users.find(function (user) {
	            return user.id === copy.id_user;
	          });
	        } else {
	          copy.type = 'log';
	        }
	      ...
	      var logsJsx = logsAndComments.map(function (item) {
	        var type = item.type;
	        if (type === 'comment') {
	          return _react2.default.createElement(
	            _Row2.default,
	            { className: 'rows-alt comment' },
	            _react2.default.createElement(
	              _Col2.default,
	              { xs: 6, className: 'col' },
	              _react2.default.createElement(_reactIntl.FormattedDate, { value: item.date, day: 'numeric', month: 'long', year: 'numeric' }),
	              '\xA0',
	              (0, _moment2.default)(item.date).format('hh:mm:ss')
	            ),
	            _react2.default.createElement(
	              _Col2.default,
	              { xs: 6, className: 'col' },
	              ...
	              _react2.default.createElement(_comment2.default, { className: 'ico-comment' })
	            )
	          );
	        }
	        return _react2.default.createElement(
	          _Row2.default,
	          { className: 'rows-alt log' },
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 6 },
	            _react2.default.createElement(_reactIntl.FormattedDate, { value: item.date, day: 'numeric', month: 'long', year: 'numeric' }),
	          ...
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 6 },
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: item.step })
	          )
	        );
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 6, className: 'th' },
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'Date' })
	          ),
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 6, className: 'th' },
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'steps/comments' })
	          )
	        ),
	        logsJsx,
	        _react2.default.createElement(_Row2.default, { style: { padding: '25px' } }),
	        _react2.default.createElement(
	          _Row2.default,
	          null,
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 9 },
	            _react2.default.createElement(_Input2.default, { type: 'textarea', onChange: _this.onChangeComment, value: _this.state.comment, style: { height: '48px', minHeight: 'initial' }, placeholder: formattedMessage({ id: 'comment' }) + ' ...' })
	          ),
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 3 },
	            _react2.default.createElement(
	              _Button2.default,
	              { onClick: _this.onSubmitComment, className: 'btn-green', style: { width: '100%', marginTop: '4px' } },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'add_log' })
	            )
	          )
	        )
	      );
	    ...
	    _this.onEnter = function () {
	      console.log('onEnter!!!');
	      _this.getTimelineLogsDirty();
	      _this.getTimelinesDataDirty();
	    };
	
	    _this.getTimelineLogsDirty = function () {
	      // This is a quick and dirty ajax call to get the timeline data
	      _axios2.default.get(_this.props.workflow.endpoint.front + 'workflow/' + _this.props.workflowId + '/log').then(function (_ref) {
	        var data = _ref.data;
	    ...
	    _this.getTimelinesDataDirty = function () {
	      _axios2.default.get(_this.props.workflow.endpoint.front + 'workflow/' + _this.props.workflowId).then(function (_ref2) {
	        var data = _ref2.data;
	
	        console.log('endpoint data', data);
	        _this.setState({ timelines: data });
	      });
	    };
	    ...
	    _this.timelinesComponent = _timeline2.default.get(props.tenant);
	    return _this;
	  }
	
	  _createClass(ModalTimeLine, [{
	    ...
	    value: function render() {
	      ...
	      var Timelines = this.timelinesComponent;
	      ...
	      var _map = [_horizontalMenu2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	          ...
	          HorizontalMenu = _map2[0];
	
	      return _react2.default.createElement(
	        _Modal2.default,
	        { show: this.props.show, onHide: this.hide, onEnter: this.onEnter, dialogClassName: 'modal-half' },
	        _react2.default.createElement(
	          _Modal2.default.Header,
	          null,
	          _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'track' })
	        ),
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                { onClick: function onClick() {
	                    return _this2.setState({ tab: 'timeline' });
	                  }, className: this.state.tab === 'timeline' ? 'active' : '' },
	                _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'timelines' })
	              ),
	              _react2.default.createElement(
	                'a',
	                { onClick: function onClick() {
	                    return _this2.setState({ tab: 'log' });
	                  }, className: this.state.tab !== 'timeline' ? 'active' : '' },
	                _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'timeline_details' })
	              )
	            ),
	            _react2.default.createElement(
	              'div',
	              { style: { margin: '20px auto' } },
	              this.state.tab === 'timeline' ? _react2.default.createElement(Timelines, { timelines: timelines }) : _react2.default.createElement(
	                'div',
	                null,
	                !this.state.logs ? _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'loading' }) : this.getLogsAndCommentsMarkup(this.state.logs, this.props.logComments.toJS().filter(function (comment) {
	                  return comment.id_workflow === _this2.props.workflowId;
	                }))
	              )
	            )
	          )
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _Button2.default,
	            { bsStyle: 'primary', onClick: this.hide },
	...
	var _components = { default: (0, _reactRedux.connect)(stateToProps)(ModalTimeLine) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fastForward = __webpack_require__(483);
	...
	var _accessTime = __webpack_require__(478);
	
	var _accessTime2 = _interopRequireDefault(_accessTime);
	
	var _cached = __webpack_require__(479);
	...
	var Timeline = (_temp2 = _class = function (_Components) {
	  ...
	  function Timeline() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Timeline.__proto__ || Object.getPrototypeOf(Timeline)).call.apply(_ref, [this].concat(args))), _this), _this.getTimelineJSX = function (timeline) {
	      var StepIcon = function StepIcon(_ref2) {
	        var status = _ref2.status;
	        return _react2.default.createElement(
	          'div',
	          { className: 'step-point tl-step-' + status },
	          status === 'start' && _react2.default.createElement(_fastForward2.default, { className: 'ico' }),
	          status === 'done' && _react2.default.createElement(_check2.default, { className: 'ico' }),
	          status === 'inprogress' && _react2.default.createElement(_cached2.default, { className: 'ico' }),
	          status === 'todo' && _react2.default.createElement(_accessTime2.default, { className: 'ico' })
	        );
	      };
	
	      var TimelineStep = function TimelineStep(_ref3) {
	        var step = _ref3.step,
	            index = _ref3.index;
	        return _react2.default.createElement(
	          'div',
	          { className: 'step tl-step-' + step.status },
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { className: 'step-inter tl-step-' + step.status },
	                _react2.default.createElement(
	                  'span',
	              ...
	              _react2.default.createElement(StepIcon, { status: step.status })
	            )
	          )
	        );
	      };
	
	      var timelineStepsJSX = timeline.steps.map(function (step, i) {
	        return _react2.default.createElement(TimelineStep, { step: step, index: i, key: i });
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h3',
	          null,
	          _react2.default.createElement('span', { className: 'glyphicon ' + timeline.icon + ' ico-left' }),
	          timeline.name,
	          ' - (',
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'timeline' },
	          _react2.default.createElement(StepIcon, { status: 'start', size: 60 }),
	          timelineStepsJSX
	        )
	      );
	  ...
	  _createClass(Timeline, [{
	    ...
	    value: function render() {
	      ...
	      var timelinesJSX = timelines.map(this.getTimelineJSX);
	      return _react2.default.createElement(
	        'div',
	        null,
	        timelinesJSX
	...
	var _components = { default: Timeline };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FaCheck = (function (_React$Component) {
	    ...
	    FaCheck.prototype.render = function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdCached = (function (_React$Component) {
	    ...
	    MdCached.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdComment = (function (_React$Component) {
	    ...
	    MdComment.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalTimeline = __webpack_require__(468);
	
	var _modalTimeline2 = _interopRequireDefault(_modalTimeline);
	...
	var Assignments = function (_Components) {
	  _inherits(Assignments, _Components);
	  ...
	  function Assignments(props) {
	    ...
	    _this.hideModal = function (sModal) {
	      switch (sModal) {
	        case 'timeline':
	          return _this.setState({ timeline: null, timelineModal: false });
	        default:
	          break;
	      }
	    };
	
	    _this.showModal = function (sModal, oData) {
	      switch (sModal) {
	        case 'timeline':
	          _this.setState({ timeline: oData, timelineModal: true });
	          break;
	        default:
	          break;
	      }
	  ...
	  _createClass(Assignments, [{
	    ...
	    value: function _getMenuItems() {
	      var menuitems = [{ url: '/admin/follow-ups/draft', title: this.format({ id: 'orders_manage' }) }, { url: '/admin/follow-ups/in-progress', title: this.format({ id: 'in_progress' }), extraInfo: this.format({ id: 'action_can_be_required' }) }, { url: '/admin/follow-ups/done', title: this.format({ id: 'done' }) }];
	      return menuitems;
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var _map = [_modalTimeline2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          ModalTimeLine = _map2[0];
	
	      var children = _react2.default.Children.map(this.props.children, function (child) {
	        return _react2.default.cloneElement(child, _extends({
	          random: Math.random(),
	          showModal: _this2.showModal,
	          hideModal: _this2.hideModal,
	          detail: _this2.detail
	        }, _this2.state));
	      });
	
	      var _map3 = [_horizontalMenuNew2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	      ...
	      var menu = menuitems.map(function (data) {
	        var extraInfo = _react2.default.createElement('span', null);
	        if (data.extraInfo) {
	          extraInfo = _react2.default.createElement(
	            'span',
	            { style: { position: 'absolute', right: '0', bottom: '20' }, className: 'hidden-sm-down' },
	            _react2.default.createElement(
	              _OverlayTrigger2.default,
	              ...
	              _react2.default.createElement(_Glyphicon2.default, { glyph: 'info-sign' })
	            )
	          );
	        }
	        return _react2.default.createElement(
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 12, className: 'table-container' },
	            children
	          )
	        ),
	        !!this.state.timelineModal && _react2.default.createElement(ModalTimeLine, { assignment: this.state.timeline, show: !!this.state.timelineModal, onHide: function onHide() {
	            return _this2.hideModal('timeline');
	          } })
	      );
	    }
	  }]);
	...
	var _components = {
	  default: (0, _reactRedux.connect)(stateToProps)(Assignments)
	};
