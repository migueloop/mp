...
/***/ function(module, exports, __webpack_require__) {
	...
	var _product = __webpack_require__(530);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _products = __webpack_require__(501);
	...
	var ModalFilterProducts = (_temp = _class = function (_Components) {
	  _inherits(ModalFilterProducts, _Components);
	
	  function ModalFilterProducts(props) {
	    _classCallCheck(this, ModalFilterProducts);
	
	    var _this = _possibleConstructorReturn(this, (ModalFilterProducts.__proto__ || Object.getPrototypeOf(ModalFilterProducts)).call(this, props));
	
	    _this.onSelect = function (oProduct) {
	      var oComponent = {
	      ...
	      _this.props.onSelect(oComponent);
	    };
	  ...
	  _createClass(ModalFilterProducts, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_products2.default].map(function (cmpt) {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'select_product_to_add' })
	            )
	          )
	        ),
	        _react2.default.createElement(
	...
	var _components = {
	  default: (0, _connect2.default)(stateToProps)(ModalFilterProducts)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _product = __webpack_require__(666);
	...
	var Header = (_dec = (0, _reactRedux.connect)(function (state) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      ...
	      var Product = _product2.default.get(this.props.tenant);
	
	      // let {title, ...otherProps} = this.props;
	      var bestProducts = this.props.bestProducts.map(function (product, index, products) {
	        return _react2.default.createElement(
	          _reactBootstrap.Col,
	          { key: product.id, xs: 6, md: 4, lg: 4 },
	          _react2.default.createElement(Product, { product: product, md: 4, lg: 4, sm: 6, xs: 6, className: 'cursor',
	            onClick: _this2.props.selectBest(index + 1), draggable: true,
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _reactBootstrap.Col,
	            { md: 5, sm: 12, xs: 12, lg: 6 },
	            _react2.default.createElement(
	              'div',
	              { className: 'cover', style: { position: 'relative' } },
	              _react2.default.createElement(
	                _reactDropzone2.default,
	                { style: { width: 'auto', height: 'auto', border: 'none' }, onDrop: this.props.onDrop,
	                  accept: this.props.mimeAlloweds.join(',') },
	                _react2.default.createElement(
	                  'div',
	                  { style: { textAlign: 'center' } },
	                  _react2.default.createElement('img', { ref: 'logo', src: this.props.logo, style: { maxHeight: 310, maxWidth: '100%' },
	                    alt: '' }),
	                  _react2.default.createElement(
	                    'div',
	                    { style: { position: 'absolute', left: 10, right: 10, bottom: 0 } },
	                    _react2.default.createElement(
	                      _reactBootstrap.Col,
	                      { lgOffset: 2, lg: 8,
	                        style: {
	                      ...
	                      _react2.default.createElement(
	                        'label',
	                        null,
	                        _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'click_or_drop_to_change_logo' })
	                      )
	                    )
	                  )
	                )
	          ...
	          _react2.default.createElement(
	            _reactBootstrap.Col,
	            { md: 7, sm: 12, xs: 12, lg: 6 },
	            _react2.default.createElement(
	              _reactBootstrap.Row,
	              null,
	              _react2.default.createElement(
	                _reactBootstrap.Col,
	                { md: 8, mdOffset: 2, style: { marginTop: 15 } },
	                _react2.default.createElement(_reactBootstrap.Input, { type: 'text', placeholder: 'Corner Name', name: 'title',
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                _reactBootstrap.Col,
	                { mdOffset: 1, md: 10, className: 'mp-products grid' },
	                bestProducts
	              )
	            )
	          )
	  ...
	  _createClass(Product, [{
	    ...
	    value: function render() {
	      ...
	      var _props = this.props,
	          ...
	          offer = _props.offer,
	          className = _props.className,
	          others = _objectWithoutProperties(_props, ['route', 'product', 'link', 'offer', 'className']);
	
	      var productOwner = users.find(function (user) {
	        return user.id === product.created_by;
	      });
	      var productOwnerName = productOwner && productOwner.name + ' ' + productOwner.lastname;
	      // Product offer?
	      var offerView = null;
	      if (offer) {
	        offerView = _react2.default.createElement(
	      ...
	      if (link) {
	        productView = _react2.default.createElement(
	          _reactRouter.Link,
	          { to: route + '/' + product.alias + '/', className: 'url u-url', rel: 'product' },
	          productView
	        );
	      }
	      return _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Details = (_temp = _class = function (_Components) {
	  ...
	  _createClass(Details, [{
	    ...
	    value: function render() {
	      ...
	      var keywordsOptions = {
	        ...
	        values: this.props.keywords.map(function (keyword) {
	          return { label: keyword.name, value: keyword.id };
	        }),
	        options: this.props.keywordsAvailables.map(function (keyword) {
	          return { label: keyword.name, value: keyword.id };
	        }),
	        onValuesChange: function onValuesChange(keywords, callback) {
	          _this2.props.update('keywords')({
	            target: {
	              value: keywords.map(function (k) {
	                return { id: k.value, name: k.label, newOption: k.newOption };
	              })
	            }
	          });
	          callback();
	        },
	        createFromSearch: function createFromSearch(options, values, search) {
	          if (search.length === 0 || values.map(function (value) {
	        ...
	        renderNoResultsFound: function renderNoResultsFound(values, search) {
	          return _react2.default.createElement(
	            'div',
	            { className: 'no-results-found' },
	            function () {
	              ...
	              } else if (values.map(function (value) {
	                return value.label.toLowerCase();
	              }).indexOf(search.toLowerCase()) !== -1) {
	          ...
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { onClick: function onClick() {
	                  _this2.props.update('keywords')({
	                    target: {
	                      value: _this2.props.keywords.filter(function (clickedItem) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _reactBootstrap.Col,
	            { md: 4, mdOffset: 2, sm: 6 },
	            _react2.default.createElement(
	              'label',
	              { className: 'control-label' },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'keywords' })
	            ),
	            _react2.default.createElement(_reactSelectize.MultiSelect, keywordsOptions)
	          )
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _details = __webpack_require__(1058);
	...
	var _modalFilterProducts = __webpack_require__(532);
	
	var _modalFilterProducts2 = _interopRequireDefault(_modalFilterProducts);
	...
	var EditForm = (_temp = _class = function (_Components) {
	  _inherits(EditForm, _Components);
	  ...
	  function EditForm(props) {
	    ...
	    var corner = props.corners.find(function (corner) {
	      return parseInt(corner.id, 10) === parseInt(props.params.id, 10);
	    });
	    ...
	    corner.products = corner.products.map(function (product) {
	      return _extends({}, props.products.find(function (p) {
	        return p.id === product.id;
	      }), { highlight_product: product.highlight_product });
	    }).filter(function (product) {
	      return product.state === _constants.PRODUCT.STATE.PUBLISHED;
	    });
	    console.log('corner', corner);
	    var bestProducts = corner.products.reduce(function (prev, product) {
	  ...
	  _createClass(EditForm, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      var bestProducts = this.state.bestProducts;
	
	      bestProducts.forEach(function (bestProduct) {
	        if (!bestProduct.name) {
	          bestProduct.name = _this2.format({ id: 'select_a_product' });
	        }
	      });
	      this.setState({ bestProducts: bestProducts });
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      var _map = [_header2.default, _details2.default, _products2.default, _modalFilterProducts2.default].map(function (cmpt) {
	        return cmpt.get(_this4.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 4),
	          Header = _map2[0],
	          Details = _map2[1],
	          Products = _map2[2],
	          ModalFilterProducts = _map2[3];
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'page-corners container' },
	        _react2.default.createElement(
	          'section',
	          { className: 'voffset-top-2 mp-corner' },
	          _react2.default.createElement(Header, { logo: this.state.corner.logoUrl, title: this.state.corner.name, onDrop: this.onDrop,
	          ...
	          _react2.default.createElement(Details, { description: this.state.corner.description, update: this.update, onChange: this.onChange,
	            keywords: this.state.corner.keywords, keywordsAvailables: this.props.misc.keywords }),
	          _react2.default.createElement(
	            _reactBootstrap.Well,
	            null,
	            _react2.default.createElement(Products, { products: this.state.corner.products })
	          )
	        ),
	        _react2.default.createElement(ModalFilterProducts, {
	          show: this.state.showModalSelectBestProduct,
	          hide: function hide() {
	            return _this4.setState({ showModalSelectBestProduct: false });
	          },
	  ...
	  this.onDrop = function (dropEvent) {
	    if (mimeAlloweds.indexOf(dropEvent[0].type) === -1) {
	      _this5.props.notification.add({
	    ...
	    var previousLogo = _this5.state.corner.logoUrl;
	
	    _this5.setState({
	      loading: true
	    });
	    new _actions2.default(_this5.props.tenant).Corners.UpdateLogo(_this5.state.corner, dropEvent[0]).then(function (action) {
	      _this5.props.dispatch(action);
	      _this5.setState({
	        corner: _extends({}, _this5.state.corner, action.corner),
	        loading: false
	      });
	  ...
	  this.onChange = function (type) {
	    return function (event) {
	      var corner = _this5.state.corner;
	  ...
	  this.update = function (type) {
	    return function (event) {
	      // no change detected
	      var lastUpdate = _this5.state.changes[_this5.state.changes.length - 1];
	        ...
	        _this5.props.notification.add({
	          ...
	          action: {
	            ...
	            callback: function callback() {
	              var rollback = _this5.state.changes.concat([]).pop();
	              var obj = {};
	              obj[rollback.type] = rollback.value;
	              _this5.setState({
	                corner: _extends({}, _this5.state.corner, obj)
	              });
	            }
	          }
	        });
	      ...
	      new _actions2.default(_this5.props.tenant).Corners.Edit(_this5.state.corner.id, obj).then(function (action) {
	        _this5.props.dispatch(action);
	        _this5.props.notification.add({
	        ...
	        var changes = _this5.state.changes.concat([]);
	        var lastUpdate = changes.pop();
	        var obj = {};
	      ...
	      _this5.setState({
	        corner: _extends(_this5.state.corner, obj),
	        changes: _this5.state.changes.concat({
	          value: _this5.state.corner[type],
	          type: type
	        })
	      });
	    };
	  ...
	  this.selectBestProduct = function (index) {
	  ...
	  this.onSelectBestProduct = function (product) {
	    var index = _this5.state.bestProductPosition;
	    var bests = _this5.state.bestProducts.concat([]);
	    var oldProduct = bests[index - 1];
	    bests[index - 1] = product;
	    new _actions2.default(_this5.props.tenant).Corners.UpdateBestProduct(_this5.state.corner.id, product.id, index).then(function (action) {
	      _this5.props.dispatch(action);
	      _this5.props.notification.add({
	        message: 'Corner Updated',
	        level: 'success'
