...
/***/ function(module, exports, __webpack_require__) {
	...
	var Settings = (_dec = (0, _reactRedux.connect)(function (state) {
	  ...
	  function Settings(props) {
	    ...
	    _this.changeValue = function (evt) {
	      var params = {};
	    ...
	    _this.updateForm = function (evt) {
	      ...
	      if (_this.previousValues[evt.currentTarget.name] !== evt.currentTarget.value) {
	        (function () {
	          var params = {};
	          var event = _extends({}, evt);
	
	          params[evt.currentTarget.name] = evt.currentTarget.value;
	          // API Call
	          new _actions2.default(_this.props.tenant).BackOffice.Settings.setSEO(params).then(function (action) {
	            // dispatch Action to Store/Reducer
	            _this.props.dispatch(action);
	
	            // set the value to check again
	            _this.previousValues[event.currentTarget.name] = event.currentTarget.value;
	            // show notification
	            _this.props.notification.add({ message: 'Settings saved', level: 'success' });
	          }).catch(function () {
	            var state = _extends({}, _this.state);
	
	            // rollback changes of state
	            state[event.currentTarget.name] = _this.previousValues[event.currentTarget.name];
	            _this.setState(state);
	            // show notification
	            _this.props.notification.add({ message: 'There was an error saving settings', level: 'error' });
	          });
	        })();
	      }
	    };
	    ...
	    _this.state = {
	      description: _this.props.settings.seo.description,
	      tagline: _this.props.settings.seo.tagline,
	      title: _this.props.settings.seo.title
	    };
	
	    _this.previousValues = _extends({}, _this.state);
	    return _this;
	  }
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  null,
	                  'Site Name',
	                  _react2.default.createElement('input', { type: 'text', name: 'title', className: 'form-control', value: this.state.title,
	                ...
	                _react2.default.createElement(
	                  ...
	                  null,
	                  'Tag Line',
	                  _react2.default.createElement('input', { type: 'text', name: 'tagline', className: 'form-control', value: this.state.tagline,
	                    onChange: this.changeValue, onBlur: this.updateForm })
	                ),
	                _react2.default.createElement(
	                  'label',
	                  null,
	                  'Site Description',
	                  _react2.default.createElement('textarea', { required: true, name: 'description', className: 'form-control', value: this.state.description,
	                    onChange: this.changeValue, onBlur: this.updateForm })
	                )
	              )
	            )
