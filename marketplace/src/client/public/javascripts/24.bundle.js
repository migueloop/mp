...
/***/ function(module, exports, __webpack_require__) {
	...
	var DatatableDetail = function (_Components) {
	  _inherits(DatatableDetail, _Components);
	
	  function DatatableDetail() {
	    _classCallCheck(this, DatatableDetail);
	
	    return _possibleConstructorReturn(this, (DatatableDetail.__proto__ || Object.getPrototypeOf(DatatableDetail)).apply(this, arguments));
	  }
	  ...
	  _createClass(DatatableDetail, [{
	    ...
	    value: function render() {
	      ...
	      */
	      ...
	      var dataGroupsNames = data.groups.map(function (group) {
	        return _react2.default.createElement(
	          _Row2.default,
	          null,
	          _react2.default.createElement(
	      ...
	      var dataGroupsSquares = data.groups.map(function (group) {
	        return _react2.default.createElement(
	          _Col2.default,
	          { xs: 4 },
	          _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'h3',
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'user_info' })
	            )
	          ),
	          _react2.default.createElement(
	            _Row2.default,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _Col2.default,
	              { xs: 4, className: 'v-list-label' },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'email' })
	            ),
	            _react2.default.createElement(
	              _Col2.default,
	              { xs: 8 },
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'h3',
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'groups' })
	            )
	          ),
	          _react2.default.createElement(
	            _Row2.default,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  _Button2.default,
	                  { bsStyle: 'primary', className: 'btn-view btn btn-default', onClick: this.props.doSomething },
	                  _react2.default.createElement(_removeRedEye2.default, { style: { fontSize: '18px', marginRight: '7px' } }),
	                  ' Voir / Modifier'
	                )
	              )
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _datatableDetailUsers = __webpack_require__(1157);
	
	var _datatableDetailUsers2 = _interopRequireDefault(_datatableDetailUsers);
	
	var _cloudUpload = __webpack_require__(1459);
	...
	var Users = function (_Components) {
	  ...
	  function Users() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Users.__proto__ || Object.getPrototypeOf(Users)).call.apply(_ref, [this].concat(args))), _this), _this.formatDate = function (text, rowData, rowIndex) {
	      return new Date(text).toString();
	    }, _this.transformUserGroups = function (groups) {
	      var groupData = groups;
	      var numItemsToShow = 3;
	      var firstItems = groupData.slice(0, numItemsToShow);
	      var difference = groupData.length - numItemsToShow;
	      var numExtra = difference < 0 ? 0 : difference;
	      var groupList = firstItems.map(function (item) {
	        return _react2.default.createElement(
	          'li',
	          { key: item.id },
	          item.name
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'li',
	          null,
	          numExtra > 0 && '+ ' + numExtra + ' more.'
	        )
	      );
	    }, _this.transformUserRole = function (roleId, rowData) {
	      var roleName = rowData.role && _underscore2.default.isString(rowData.role.name) ? rowData.role.name : null;
	      return roleName ? _react2.default.createElement(
	        _Label2.default,
	        null,
	        _react2.default.createElement(_reactIntl.FormattedMessage, { id: roleName })
	      ) : null;
	    }, _this.transformName = function (firstName, rowData) {
	  ...
	  _createClass(Users, [{
	    ...
	    value: function componentDidMount() {
	      var actions = new _flux.Actions(this.props.tenant, this.props.user.token);
	      var requiredActions = [actions.BackOffice.Users.All];
	      // const requiredActions = Users.getActions(this.props.tenant, null, null, this.props.user);
	      requiredActions.map(this.props.dispatch);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var _map = [_datatableV2.default, _datatableDetailUsers2.default, _contentHeader2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 3),
	          Datatable = _map2[0],
	          Summary = _map2[1],
	          ContentHeader = _map2[2];
	
	      var canCreate = true; // PERMISSIONS NEEDED HERE!!
	      var createLink = _react2.default.createElement(
	        _reactRouter.Link,
	        { to: '/admin/users/new', className: 'btn btn-add pull-right', style: { zIndex: 100 } },
	        '+ ',
	        _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'user_create' })
	      );
	      var importButton = _react2.default.createElement(
	        _Button2.default,
	        { className: 'btn btn-ico-left', style: { marginRight: '7px' } },
	        _react2.default.createElement(_cloudUpload2.default, { className: 'ico ico-left', style: { height: '44px', fontSize: '18px' } }),
	        _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'import' })
	      );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'table-dynamic-row-height' },
	          _react2.default.createElement(
	            Datatable,
	            { data: users },
	            _react2.default.createElement(Datatable.DataColumn, { field: 'firstName', title: this.format({ id: 'name' }), size: 2, sortable: true, searchable: true, transform: this.transformName }),
	            _react2.default.createElement(Datatable.DataColumn, { field: 'email', title: this.format({ id: 'email' }), size: 5, sortable: true, searchable: true }),
	            _react2.default.createElement(Datatable.DataColumn, { field: 'groups', title: this.format({ id: 'groups' }), size: 2, sortable: true, searchable: true, transform: this.transformUserGroups }),
	            _react2.default.createElement(Datatable.DataColumn, { field: 'id_role', title: this.format({ id: 'role' }), size: 3, sortable: true, searchable: true, transform: this.transformUserRole }),
	            _react2.default.createElement(
	              Datatable.SummaryColumn,
	              null,
	              _react2.default.createElement(Summary, this.props)
	            )
	          )
	        )
	      );
	    ...
	    value: function getActions(tenant) {
	      ...
	      return [actions.BackOffice.Users.All];
	    }
	  }]);
	...
	var _components = { default: connector(Users) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FaCloudUpload = (function (_React$Component) {
	    ...
	    FaCloudUpload.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
