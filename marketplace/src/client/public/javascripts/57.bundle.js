...
/***/ function(module, exports, __webpack_require__) {
	...
	var MyApps = function (_Components) {
	  _inherits(MyApps, _Components);
	
	  function MyApps() {
	    _classCallCheck(this, MyApps);
	
	    return _possibleConstructorReturn(this, (MyApps.__proto__ || Object.getPrototypeOf(MyApps)).apply(this, arguments));
	  }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: '/admin/my-apps', activeClassName: 'active' },
	              this.format({ id: 'my-apps' })
	            )
	          )
	        )
	      );
