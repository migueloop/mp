	...
	var Domain = (_temp = _class = function (_Components) {
	  ...
	  _createClass(Domain, null, [{
	    ...
	    value: function getActions(tenant) {
	      ...
	      return [actions.FrontOffice.Products.fetchAll(), actions.FrontOffice.Bundles.fetchAll(), actions.Common.Misc.fetchKeywords()];
	    }
	  }]);
	  ...
	  _createClass(Domain, [{
	    ...
	    value: function render() {
	      ...
	      var _map3 = [this.props.products, this.props.bundles, this.props.keywords].map(function (item) {
	        return item.toJS();
	      }),
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(Products, { show: this.state.active === 'products', keywords: keywords, products: products }),
	          _react2.default.createElement(Bundles, { show: this.state.active === 'bundles', keywords: keywords, bundles: bundles })
	        )
	      );
	    }
	  }]);
	  ...
	  this.load = function (props) {
	    _this2.setState({
	      ...
	      Promise.all(Domain.getActions(props.tenant, props.params).map(_this2.props.dispatch)).then(function () {
