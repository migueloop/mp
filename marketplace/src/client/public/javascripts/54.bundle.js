...
/***/ function(module, exports, __webpack_require__) {
	...
	var LineOptions = function (_Components) {
	  _inherits(LineOptions, _Components);
	  ...
	  function LineOptions() {
	    ...
	    _classCallCheck(this, LineOptions);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LineOptions.__proto__ || Object.getPrototypeOf(LineOptions)).call.apply(_ref, [this].concat(args))), _this), _this.onSubmitForm = function (e) {
	      e.preventDefault();
	      console.log('Form submitted', e);
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  _createClass(LineOptions, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	
	      var _map = [_lineForm2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          LineOptionsForm = _map2[0];
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'mp-tab mp-tab-line-options' },
	        _react2.default.createElement(LineOptionsForm, { onSubmit: this.onSubmitForm })
	      );
	    }
	  }]);
	...
	var _components = { default: LineOptions };
