...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectProduct = __webpack_require__(1059);
	...
	var mimeAlloweds = ['image/png', 'image/jpg', 'image/jpeg'];
	...
	var EditForm = (_temp = _class = function (_Components) {
	  ...
	  function EditForm(props) {
	    ...
	    if (_this.props.params.id) {
	      user = _this.props.users.find(function (user) {
	        return user.id == _this.props.params.id;
	      });
	    } else {
	      user = _this.props.users.find(function (user) {
	        return user.id == _this.props.user.id;
	      });
	    }
	    ...
	    var editor = user.editorProfile;
	
	    editor.products = editor.products.map(function (product) {
	      return _extends({}, _this.props.products.find(function (p) {
	        return p.id === product.id;
	      }), { 'highlight_product': product['highlight_product'] });
	    }).filter(function (product) {
	      return product.state !== _constants.PRODUCT.STATE.DELETED;
	    });
	
	    _this.actions = new _actions2.default(_this.tenant);
	    _this.edited = false;
	    _this.originalEditor = _extends({}, editor);
	    _this.lastUpdate = _extends({}, editor);
	
	    var bestProducts = editor.products.reduce(function (prev, product) {
	  ...
	  _createClass(EditForm, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_header2.default, _products2.default, _selectProduct2.default, _modalFilterProducts2.default].map(function (cmpt) {
	        return cmpt.get(_this3.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 4),
	          Header = _map2[0],
	          Products = _map2[1],
	          SelectProduct = _map2[2],
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'section',
	          { className: 'mp-corner' },
	          _react2.default.createElement(Header, { logo: this.state.editor.logoUrl, title: this.state.editor.title, onDrop: this.onDrop,
	          ...
	          _react2.default.createElement(
	            _reactBootstrap.Well,
	            null,
	            _react2.default.createElement(Products, { products: this.state.editor.products })
	          )
	        ),
	        _react2.default.createElement(ModalFilterProducts, {
	          show: this.state.showModalSelectBestProduct,
	          hide: function hide() {
	            return _this3.setState({ showModalSelectBestProduct: false });
	          },
	  ...
	  this.onDrop = function (dropEvent) {
	    ...
	    var previousLogo = _this4.state.editor.logoUrl;
	
	    _this4.setState({
	      loading: true
	    });
	    _this4.actions.BackOffice.Users.Editor.UpdateLogo(_this4.state.editor, dropEvent[0]).then(function (action) {
	      _this4.props.dispatch(action);
	      _this4.setState({
	        editor: _extends({}, _this4.state.editor, action.editorProfile),
	        loading: false
	      });
	  ...
	  this.onChange = function (type) {
	    return function (event) {
	      var editor = _extends({}, _this4.state.editor);
	  ...
	  this.update = function (type) {
	    return function (event) {
	      ...
	      if (_this4.lastUpdate[type] == event.target.value) {
	        return;
	      }
	      ...
	      _this4.oldValues[type] = _this4.originalEditor[type];
	
	      var obj = {};
	      obj[type] = event.target.value;
	
	      _this4.actions.BackOffice.Users.Editor.Edit(_this4.state.editor.id_user, obj).then(function (action) {
	        _this4.props.dispatch(action);
	        _extends(_this4.lastUpdate, obj);
	        _this4.props.notification.add({
	        ...
	        _this4.setState({
	          editor: _extends(_this4.state.editor, _this4.lastUpdate)
	        });
	        _this4.props.notification.add({
	      ...
	      _this4.setState({
	        editor: _extends(_this4.state.editor, obj)
	      });
	    };
	  };
	  ...
	  this.onSelectBestProduct = function (product) {
	    var index = _this4.state.bestProductPosition;
	    var bests = _this4.state.bestProducts.concat([]);
	    var oldProduct = bests[index - 1];
	    bests[index - 1] = product;
	    _this4.actions.BackOffice.Users.Editor.UpdateBestProduct(_this4.state.editor.id_user, product.id, index).then(function (action) {
	      _this4.props.dispatch(action);
	    }).catch(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectProduct = (_dec = (0, _reactRedux.connect)(function (state) {
	  ...
	  _inherits(SelectProduct, _Components);
	  ...
	  _createClass(SelectProduct, [{
	    key: 'render',
	    value: function render() {
	      var Products = _products2.default.get(this.props.tenant);
	      return _react2.default.createElement(
	        _reactBootstrap.Modal,
	        { bsSize: 'large', show: this.props.show, onHide: this.props.onHide },
	        _react2.default.createElement(
	          'h3',
	          null,
	          _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'select_product' })
	        ),
	        _react2.default.createElement(
	          'div',
	          { style: { margin: 20 } },
	          _react2.default.createElement(Products, { products: this.props.products, omit: this.props.omit, onSelect: this.props.onSelect })
	        )
	      );
	    }
	  }]);
	...
	}(_baseComponent2.default), _class2.propTypes = {
	  show: _react2.default.PropTypes.bool,
	  onHide: _react2.default.PropTypes.func,
	  onSelect: _react2.default.PropTypes.func,
	  products: _react2.default.PropTypes.array.isRequired,
