...
/***/ function(module, exports, __webpack_require__) {
	...
	var Product = (_temp = _class = function (_Components) {
	  _inherits(Product, _Components);
	  ...
	  _createClass(Product, [{
	    ...
	    value: function render() {
	      var _props = this.props,
	          ...
	          others = _objectWithoutProperties(_props, ['product', 'link', 'offer', 'className']);
	      // Product offer?
	
	
	      var offerView = null;
	      if (offer) {
	        offerView = _react2.default.createElement(
	          'p',
	          { className: 'offer' },
	          offer.AmountRecurrence / 100,
	          '/',
	          offer.UnitRecurrence
	        );
	      }
	
	      // Product view
	      var productView = _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          'div',
	          { className: 'thumb' },
	          _react2.default.createElement('img', { className: 'photo u-photo', src: product.logoUrl, alt: product.name })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'info' },
	          _react2.default.createElement(
	            'p',
	            { className: 'brand p-brand' },
	            product.editor ? product.editor.title : ''
	          ),
	          _react2.default.createElement(
	            'h4',
	            { className: 'title fn p-name' },
	            product.name
	          ),
	          offerView
	        )
	      ...
	      // Embed in link?
	      if (link) {
	        productView = _react2.default.createElement(
	          _reactRouter.Link,
	          { to: link, className: 'url u-url', rel: 'product' },
	          productView
	        );
	      }
	      return _react2.default.createElement(
	        'div',
	        _extends({ className: 'product hproduct h-product ' + className }, others),
	        productView
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bundle = (_temp = _class = function (_Components) {
	  _inherits(Bundle, _Components);
	  ...
	  _createClass(Bundle, [{
	    ...
	    value: function render() {
	      var _props = this.props,
	          ...
	          link = _props.link,
	          others = _objectWithoutProperties(_props, ['route', 'bundle', 'link']);
	
	      var bundleView = _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          'div',
	      ...
	      if (link) {
	        bundleView = _react2.default.createElement(
	          _reactRouter.Link,
	          { to: route + '/' + bundle.alias, className: 'url u-url', rel: 'bundle' },
	          bundleView
	        );
	      }
	      ...
	      return _react2.default.createElement(
	        'div',
	        _extends({ className: 'product hproduct h-product' }, others),
	        bundleView
	      );
	    }
	  }]);
	  ...
	  link: _react2.default.PropTypes.bool.isRequired
	}, _class.defaultProps = {
	  route: '/bundle',
	  link: false
	}, _temp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bundle = __webpack_require__(563);
	...
	var Bundles = (_temp = _class = function (_Components) {
	  _inherits(Bundles, _Components);
	
	  function Bundles(props) {
	    _classCallCheck(this, Bundles);
	
	    var _this = _possibleConstructorReturn(this, (Bundles.__proto__ || Object.getPrototypeOf(Bundles)).call(this, props));
	
	    _this.paginationProperties = {
	      items: 3,
	      maxButtons: 3,
	      bsSize: 'small',
	      next: true,
	  ...
	  _createClass(Bundles, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_bundle2.default].map(function (Component) {
	        return Component.get(tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          Bundle = _map2[0];
	
	      var start = this.props.itemsPerPage * (this.state.page - 1);
	
	      var aBundles = this.props.bundles.filter(function (oBundle) {
	        return _this2.props.omit.map(function (p) {
	          return p.id;
	        }).indexOf(oBundle.id) === -1;
	      });
	
	      var grid = aBundles.slice(start, start + this.props.itemsPerPage).map(function (oBundle) {
	        var bundleProps = {};
	
	        if (_this2.props.onSelect) {
	          bundleProps = {
	            onClick: function onClick() {
	              _this2.props.onSelect(oBundle);
	            }
	          };
	        }
	        ...
	        return _react2.default.createElement(
	          _reactBootstrap.Col,
	          { xs: 12, sm: 6, md: 3, lg: 2, key: oBundle.id },
	          _react2.default.createElement(Bundle, _extends({}, bundleProps, {
	            bundle: oBundle,
	      ...
	      if (!aBundles.length) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'mp-products' },
	          _react2.default.createElement(
	            'h3',
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'bundles_empty' })
	          )
	        );
	      }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'nav',
	          { className: 'pages' },
	          _react2.default.createElement(_reactBootstrap.Pagination, _extends({}, this.paginationProperties, {
	  ...
	  bundles: _react2.default.PropTypes.array.isRequired,
	  link: _react2.default.PropTypes.bool.isRequired,
	  omit: _react2.default.PropTypes.array,
	  onSelect: _react2.default.PropTypes.func
	}, _class.defaultProps = {
	  itemsPerPage: 12,
	  omit: []
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Products = (_temp = _class = function (_Components) {
	  _inherits(Products, _Components);
	  ...
	  function Products(props) {
	    ...
	    _this.paginationProperties = {
	      ...
	      prev: true,
	      onSelect: function onSelect(event, selectedEvent) {
	        _this.setState({ page: selectedEvent.eventKey });
	      }
	    };
	  ...
	  _createClass(Products, [{
	    ...
	    value: function render() {
	      ...
	      var grid = products.slice(start, start + this.props.itemsPerPage).map(function (product) {
	        var productProps = {};
	        if (_this2.props.onSelect) {
	          productProps = {
	            onClick: function onClick() {
	              _this2.props.onSelect(product);
	            },
	            className: 'cursor'
	          };
	        }
	        return _react2.default.createElement(
	          _reactBootstrap.Col,
	          { xs: 6, sm: 6, md: 3, lg: 2, key: product.id },
	          _react2.default.createElement(_product2.default, _extends({ product: product }, productProps, {
	            link: product.url
	          }))
	        );
	      });
	      if (!products.length) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h3',
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'products_empty' })
	          )
	        );
	      }
	      return _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _components2 = __webpack_require__(564);
	...
	var ListBundles = function (_Components) {
	  _inherits(ListBundles, _Components);
	
	  function ListBundles(props) {
	    _classCallCheck(this, ListBundles);
	
	    var _this = _possibleConstructorReturn(this, (ListBundles.__proto__ || Object.getPrototypeOf(ListBundles)).call(this, props));
	  ...
	  _createClass(ListBundles, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_components3.default].map(function (cmpt) {
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(Bundles, { bundles: this.props.bundles, link: true })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeaderMsp = function (_Components) {
	  _inherits(HeaderMsp, _Components);
	
	  function HeaderMsp() {
	    _classCallCheck(this, HeaderMsp);
	
	    return _possibleConstructorReturn(this, (HeaderMsp.__proto__ || Object.getPrototypeOf(HeaderMsp)).apply(this, arguments));
	  }
	
	  _createClass(HeaderMsp, [{
	    key: 'render',
	    value: function render() {
	      var corner = this.props.corner;
	      var row = this.props.bestProducts.map(function (product) {
	        return _react2.default.createElement(
	          _reactBootstrap.Col,
	          { xs: 6, md: 4, lg: 4, key: product.id },
	          _react2.default.createElement(_product2.default, { product: product, link: true })
	        );
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'cover corner ' + (corner && corner.name ? 'corner-' + corner.name.toLowerCase() : '') },
	              _react2.default.createElement(
	                'div',
	                { className: 'a' },
	                _react2.default.createElement('img', { className: 'photo', src: this.props.logo, alt: '' })
	              )
	            ),
	            _react2.default.createElement(
	              'div',
	          ...
	          _react2.default.createElement(
	            _reactBootstrap.Col,
	            { md: 6, lg: 5, mdOffset: 1, lgOffset: 2 },
	            _react2.default.createElement(
	              'div',
	              { className: 'info' },
	              _react2.default.createElement(
	                'div',
	                { className: 'mp-products featured' },
	                _react2.default.createElement(
	                  'div',
	                  { className: 'row' },
	                  row
	...
	exports.default = connector(HeaderMsp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _frontItemGroupsHeaderMississippi = __webpack_require__(584);
	
	var _frontItemGroupsHeaderMississippi2 = _interopRequireDefault(_frontItemGroupsHeaderMississippi);
	...
	var Header = (_temp = _class = function (_Components) {
	    ...
	    value: function render() {
	      var row = this.props.bestProducts.map(function (product) {
	        return _react2.default.createElement(
	          _reactBootstrap.Col,
	          { xs: 6, md: 4, lg: 4, key: product.id },
	          _react2.default.createElement(_product2.default, { product: product, link: product.url })
	        );
	      });
	      var title = this.props.title ? this.props.title : this.props.formattedTitle;
	      var formattedTitle = this.format({ id: title });
	      console.log('formattedTitle', formattedTitle);
	      return _react2.default.createElement(
	        'header',
	        { className: 'about well' },
	        _react2.default.createElement(
	          _reactBootstrap.Row,
	          null,
	          _react2.default.createElement(
	  ...
	  title: _react2.default.PropTypes.string,
	  bestProducts: _react2.default.PropTypes.array.isRequired,
	  logo: _react2.default.PropTypes.string.isRequired,
	  formattedTitle: _react2.default.PropTypes.object
	}, _temp);
	...
	var _components = {
	  ...
	  mississippi: _frontItemGroupsHeaderMississippi2.default
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var connector = (0, _reactRedux.connect)(function (state) {
	  return { tenant: state.get('v02').get('common').get('tenant').get('name'), corners: state.get('corners').toJS() };
	});
	
	var CornerFilter = function (_Components) {
	  _inherits(CornerFilter, _Components);
	
	  function CornerFilter(props) {
	    _classCallCheck(this, CornerFilter);
	
	    var _this = _possibleConstructorReturn(this, (CornerFilter.__proto__ || Object.getPrototypeOf(CornerFilter)).call(this, props));
	
	    _this.onChange = function (e) {
	      var domain = parseInt(e.target.value, 10);
	      _this.setState({ domain: domain });
	      _this.props.onFilter({ domain: domain });
	    };
	  ...
	  _createClass(CornerFilter, [{
	    key: 'renderCornerOptions',
	    value: function renderCornerOptions() {
	      return this.props.domains.map(function (domain) {
	        return _react2.default.createElement(
	          'option',
	...
	var _components = { default: connector(CornerFilter) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keywordList = __webpack_require__(588);
	...
	var KeywordFilter = function (_Components) {
	  _inherits(KeywordFilter, _Components);
	
	  function KeywordFilter(props) {
	    _classCallCheck(this, KeywordFilter);
	
	    var _this = _possibleConstructorReturn(this, (KeywordFilter.__proto__ || Object.getPrototypeOf(KeywordFilter)).call(this, props));
	
	    _this.onSelectKeyword = function (keyword) {
	      return function () {
	        var keywords = _this.state.keywords.concat([]);
	        var itemInArray = keywords.find(function (kw) {
	          return kw.name === keyword.name;
	        });
	        if (itemInArray) {
	        ...
	        _this.props.onFilter({ keywords: keywords });
	      };
	    };
	
	    _this.state = { keywords: props.selectedKeywords || [] };
	    return _this;
	  }
	  ...
	  _createClass(KeywordFilter, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_keywordList2.default].map(function (Component) {
	        return Component.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          KeywordList = _map2[0];
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(KeywordList, {
	          link: false,
	...
	var _components = { default: connector(KeywordFilter) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeywordList = (_temp = _class = function (_Components) {
	  _inherits(KeywordList, _Components);
	
	  function KeywordList() {
	    _classCallCheck(this, KeywordList);
	
	    return _possibleConstructorReturn(this, (KeywordList.__proto__ || Object.getPrototypeOf(KeywordList)).apply(this, arguments));
	  }
	  ...
	  _createClass(KeywordList, [{
	    ...
	    value: function render() {
	      ...
	      var component = null;
	      var aProductKeywords = this.props.keywords.map(function (keyword) {
	        if (_this2.props.link) {
	          component = _react2.default.createElement(
	            _reactRouter.Link,
	            { to: keyword.name ? '/catalog/keywords/' + keyword.name : '#',
	              className: _this2.props.selected.find(function (k) {
	                return k.name === keyword.name;
	              }) ? 'active' : '',
	              onClick: _this2.props.onSelect(keyword) },
	            '#',
	            keyword.name
	          );
	        } else {
	          component = _react2.default.createElement(
	            'a',
	            { href: '#' + keyword.name, className: _this2.props.selected.find(function (k) {
	                return k.name === keyword.name;
	              }) ? 'active' : '',
	              onClick: function onClick(e) {
	                e.preventDefault();_this2.props.onSelect(keyword)();
	              } },
	            '#',
	            keyword.name
	          );
	        ...
	        return _react2.default.createElement(
	          'li',
	          { className: 'category p-category', key: keyword.id },
	          component
	        );
	      });
	      ...
	      return _react2.default.createElement(
	        'ul',
	        { className: 'mp-keywords categories' },
	        aProductKeywords
	      );
	    }
	  }]);
	  ...
	  keywords: _react2.default.PropTypes.array,
	  onSelect: _react2.default.PropTypes.func,
	  link: _react2.default.PropTypes.bool
	}, _class.defaultProps = {
	...
	var _components = { default: KeywordList };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PlatformFilter = function (_Components) {
	  _inherits(PlatformFilter, _Components);
	
	  function PlatformFilter(props) {
	    _classCallCheck(this, PlatformFilter);
	
	    var _this = _possibleConstructorReturn(this, (PlatformFilter.__proto__ || Object.getPrototypeOf(PlatformFilter)).call(this, props));
	
	    _this.filter = function (evt) {
	      _this.props.onFilter({ platform: evt.currentTarget.value });
	    };
	
	    _this.state = { platform: '' };
	    return _this;
	  }
	
	  _createClass(PlatformFilter, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	
	      var platforms = this.props.platforms.map(function (platform) {
	        ...
	        */
	        return _react2.default.createElement(
	          'label',
	          { key: platform.id, className: 'control-label radio' },
	          _react2.default.createElement('input', {
	            name: 'platform', type: 'radio',
	            onChange: _this2.filter,
	            checked: _this2.props.value === platform.name,
	            value: platform.name
	          }),
	          _react2.default.createElement(
	            'span',
	            { className: 'caption' },
	            _react2.default.createElement('i', { className: 'icono icono-' + platform.name.toLowerCase() }),
	            _react2.default.createElement(
	              'span',
	              { className: 'text' },
	              platform.name
	...
	var _components = { default: connector(PlatformFilter) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _asterisk = __webpack_require__(605);
	
	var _asterisk2 = _interopRequireDefault(_asterisk);
	
	var _phoneAndroid = __webpack_require__(610);
	
	var _phoneAndroid2 = _interopRequireDefault(_phoneAndroid);
	
	var _cloudQueue = __webpack_require__(607);
	
	var _cloudQueue2 = _interopRequireDefault(_cloudQueue);
	
	var _devicesOther = __webpack_require__(608);
	
	var _devicesOther2 = _interopRequireDefault(_devicesOther);
	
	var _person = __webpack_require__(609);
	
	var _person2 = _interopRequireDefault(_person);
	
	var _gitBranch = __webpack_require__(606);
	...
	var ProductTypeFilter = (_temp = _class = function (_Components) {
	  _inherits(ProductTypeFilter, _Components);
	
	  function ProductTypeFilter(props) {
	    _classCallCheck(this, ProductTypeFilter);
	
	    var _this = _possibleConstructorReturn(this, (ProductTypeFilter.__proto__ || Object.getPrototypeOf(ProductTypeFilter)).call(this, props));
	
	    _this.filter = function (evt) {
	      _this.setState({ type: evt.currentTarget.value });
	      _this.props.onFilter({ type: evt.currentTarget.value });
	    };
	  ...
	  _createClass(ProductTypeFilter, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	
	      var productTypes = Object.keys(_constants.PRODUCT.TYPE).map(function (type) {
	        // / TODO: localize!!! vvvvv ?!! vvvvvv
	        var name = type.charAt(0).toUpperCase() + type.slice(1).toLowerCase();
	
	        var Icon = 'span';
	        switch (name) {
	          case 'Mobile':
	            Icon = _phoneAndroid2.default;
	            break;
	          case 'Service':
	            Icon = _person2.default;
	            break;
	          case 'Saas':
	            Icon = _cloudQueue2.default;
	            break;
	          case 'Material':
	            Icon = _devicesOther2.default;
	            break;
	          case 'Line':
	            Icon = _gitBranch2.default;
	            break;
	          default:
	            // Icon = AllIcon;
	            break;
	        ...
	        return _react2.default.createElement(
	          'label',
	          { key: type, className: 'control-label radio' },
	          _react2.default.createElement('input', {
	            name: 'type',
	            type: 'radio',
	            value: type,
	            checked: _this2.state.type === type,
	            onChange: _this2.filter
	          }),
	          _react2.default.createElement(
	            'span',
	            { className: 'caption' },
	            _react2.default.createElement(Icon, { className: 'ico-left ico-' + name.toLowerCase() }),
	            _react2.default.createElement(
	              'span',
	              { className: 'text' },
	              name
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'label',
	          { className: 'control-label radio' },
	          _react2.default.createElement('input', { name: 'type', type: 'radio',
	            value: '',
	          ...
	          _react2.default.createElement(
	            'span',
	            { className: 'caption' },
	            _react2.default.createElement(_asterisk2.default, { className: 'ico-left ico-all' }),
	            _react2.default.createElement(
	              'span',
	              { className: 'text' },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'corner_all_types' })
	            )
	          )
	        ),
	        productTypes
	...
	var _components = { default: connector(ProductTypeFilter) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextFilter = function (_Components) {
	  _inherits(TextFilter, _Components);
	  ...
	  function TextFilter(props) {
	    ...
	    _this.filter = function (evt) {
	      _this.setState({ filter: evt.currentTarget.value });
	      var obj = {};
	      obj[_this.props.field] = evt.currentTarget.value;
	      _this.props.onFilter(obj);
	    };
	...
	var _components = { default: connector(TextFilter) };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productFilters = __webpack_require__(593);
	
	var _productFilters2 = _interopRequireDefault(_productFilters);
	
	var _products = __webpack_require__(582);
	...
	var filterProductsAlgorithm = function filterProductsAlgorithm(product, filters) {
	  if (filters.corner) {
	    var _ret = function () {
	      ...
	      var corner = filters.corner;
	      if (!product.corners.reduce(function (p, n) {
	        return n.id === corner || p;
	      }, false)) {
	        return {
	          v: false
	        };
	  ...
	  if (filters.type && product.type !== _constants.PRODUCT.TYPE[filters.type]) {
	    return false;
	  }
	  ...
	  if (filters.keywords && filters.keywords.length > 0 && !filters.keywords.reduce(function (prev, k) {
	    return prev && !!product.keywords.find(function (ProductKeyword) {
	      return k.name === ProductKeyword.name;
	    });
	  }, true)) {
	    return false;
	  }
	
	  if (filters.platform && _constants.PRODUCT.TYPE[filters.type] === _constants.PRODUCT.TYPE.MOBILE && !product.links.find(function (link) {
	    return link.name.toLowerCase() === filters.platform;
	  })) {
	    return false;
	  }
	...
	var ListProducts = function (_Components) {
	  _inherits(ListProducts, _Components);
	  ...
	  _createClass(ListProducts, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_productFilters2.default, _products2.default].map(function (cmpt) {
	        return cmpt.get(tenant);
	      }),
	          _map2 = _slicedToArray(_map, 2),
	          ProductFilters = _map2[0],
	          Products = _map2[1];
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(ProductFilters, { onFilter: this.onFilter, keywords: this.props.keywords }),
	          _react2.default.createElement(Products, { products: this.props.products.filter(function (p) {
	              return filterProductsAlgorithm(p, _this2.state.filters);
	            }), link: true })
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productTypeFilter = __webpack_require__(590);
	
	var _productTypeFilter2 = _interopRequireDefault(_productTypeFilter);
	
	var _textFilter = __webpack_require__(591);
	
	var _textFilter2 = _interopRequireDefault(_textFilter);
	
	var _platformFilter = __webpack_require__(589);
	
	var _platformFilter2 = _interopRequireDefault(_platformFilter);
	
	var _keywordFilter = __webpack_require__(587);
	
	var _keywordFilter2 = _interopRequireDefault(_keywordFilter);
	
	var _domainFilter = __webpack_require__(586);
	
	var _domainFilter2 = _interopRequireDefault(_domainFilter);
	...
	var ProductsFilters = (_temp = _class = function (_Components) {
	  _inherits(ProductsFilters, _Components);
	
	  function ProductsFilters(props) {
	    _classCallCheck(this, ProductsFilters);
	
	    var _this = _possibleConstructorReturn(this, (ProductsFilters.__proto__ || Object.getPrototypeOf(ProductsFilters)).call(this, props));
	    ...
	    _this.onFilter = function (filter) {
	      var filters = _extends({}, _this.state.filters, filter);
	      if (_constants.PRODUCT.TYPE[filters.type] !== _constants.PRODUCT.TYPE.MOBILE) {
	        filters.platform = '';
	      }
	    ...
	    _this.filter = function (evt) {
	      var filters = _extends({}, _this.state.filters);
	      filters[evt.currentTarget.name] = evt.currentTarget.value;
	      if (_constants.PRODUCT.TYPE[_this.state.filters.type] !== _constants.PRODUCT.TYPE.MOBILE) {
	        filters.platform = '';
	      }
	      _this.setState({ filters: filters });
	      _this.props.onFilter(filters);
	  ...
	  _createClass(ProductsFilters, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.props.dispatch(new _flux.Actions(this.props.tenant).Common.Misc.fetchPlatforms());
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var _map = [_productTypeFilter2.default, _textFilter2.default, _platformFilter2.default, _keywordFilter2.default, _domainFilter2.default].map(function (Component) {
	        return Component.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 5),
	          ProductTypesFilter = _map2[0],
	          TextFilter = _map2[1],
	          PlatformFilter = _map2[2],
	          KeywordFilter = _map2[3],
	          CornerFilter = _map2[4];
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { onClick: this.toggle },
	            _react2.default.createElement('i', { className: 'glyphicon glyphicon-filter' }),
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'corner_filters' })
	          )
	        ),
	        _react2.default.createElement(
	          _reactBootstrap.Collapse,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                _reactBootstrap.Col,
	                { md: 2 },
	                _react2.default.createElement(ProductTypesFilter, { onFilter: this.onFilter })
	              ),
	              _react2.default.createElement(
	                _reactBootstrap.Col,
	                { md: 3 },
	                _react2.default.createElement(TextFilter, {
	                  field: 'name',
	                  title: 'Nom',
	                ...
	                _react2.default.createElement(
	                  ...
	                  { 'in': _constants.PRODUCT.TYPE[this.state.filters.type] === _constants.PRODUCT.TYPE.MOBILE },
	                  _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(PlatformFilter, {
	                ...
	                this.props.hasCornerFilter ? _react2.default.createElement(CornerFilter, { onFilter: this.onFilter }) : ''
	              ),
	              _react2.default.createElement(
	                _reactBootstrap.Col,
	                { md: 7 },
	                _react2.default.createElement(KeywordFilter, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FaAsterisk = (function (_React$Component) {
	    ...
	    FaAsterisk.prototype.render = function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoGitBranch = (function (_React$Component) {
	    ...
	    GoGitBranch.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdCloudQueue = (function (_React$Component) {
	    ...
	    MdCloudQueue.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdDevicesOther = (function (_React$Component) {
	    ...
	    MdDevicesOther.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdPerson = (function (_React$Component) {
	    ...
	    MdPerson.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdPhoneAndroid = (function (_React$Component) {
	    ...
	    MdPhoneAndroid.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _products = __webpack_require__(592);
	
	var _products2 = _interopRequireDefault(_products);
	
	var _bundles = __webpack_require__(583);
	...
	var UserCorner = (_temp = _class = function (_Components) {
	  _inherits(UserCorner, _Components);
	
	  _createClass(UserCorner, null, [{
	    key: 'getActions',
	    value: function getActions(tenant) {
	      var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	      var query = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
	
	      var userCornerId = UserCorner.getId(params);
	      var actions = new _flux.Actions(tenant);
	      return [actions.FrontOffice.UserCorner.fetchOne(userCornerId), actions.FrontOffice.UserCorner.fetchProducts(userCornerId)];
	    }
	  }, {
	    key: 'getClientActions',
	    value: function getClientActions(tenant) {
	      var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	      var query = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
	
	      var actions = new _flux.Actions(tenant);
	      return [actions.FrontOffice.UserCorner.fetchProducts(UserCorner.getId(params)), actions.FrontOffice.UserCorner.fetchBundles(UserCorner.getId(params))];
	    }
	  }]);
	
	  function UserCorner(props) {
	    _classCallCheck(this, UserCorner);
	
	    var _this = _possibleConstructorReturn(this, (UserCorner.__proto__ || Object.getPrototypeOf(UserCorner)).call(this, props));
	  ...
	  _createClass(UserCorner, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      console.log('DID MOUNT', this.needReload(this.props));
	      UserCorner.getActions(this.props.tenant, this.props.params).concat(UserCorner.getClientActions(this.props.tenant, this.props.params)).map(this.props.dispatch);
	    }
	  }, {
	    key: 'componentWillReceiveProps',
	    value: function componentWillReceiveProps(props) {
	      ...
	      if (this.needReload(props)) {
	        this.setState({
	          ...
	          Promise.all(UserCorner.getActions(props.tenant, props.params).concat(UserCorner.getClientActions(_this2.props.tenant, _this2.props.params)).map(_this2.props.dispatch)).then(function () {
	    ...
	    key: 'groupKeywords',
	    value: function groupKeywords(keywords, item) {
	      if (!item.keywords) {
	        return keywords;
	      }
	      return keywords.concat(item.keywords.reduce(function (uniqueKeywords, keyword) {
	    ...
	    value: function render() {
	      ...
	      if (this.state.loading || !this.props.userCorner.get('idUser') || this.props.userCorner.get('idUser') !== UserCorner.getId(this.props.params)) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'h3',
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'corner_loading' })
	          )
	        );
	      }
	
	      var _map = [_header2.default, _products2.default, _bundles2.default].map(function (cmpt) {
	        return cmpt.get(tenant);
	      }),
	      ...
	      var userCorner = this.props.userCorner.toJS();
	      return _react2.default.createElement(
	        'section',
	        { className: 'mp-corner thematic ' + (userCorner.name ? 'thematic-' + userCorner.name.toLowerCase() : '') },
	        _react2.default.createElement(
	          'div',
	          { className: 'container' },
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'li',
	                { onClick: this.setMenu('products'), className: this.state.active === 'products' ? 'active' : '' },
	                _react2.default.createElement(
	                  'span',
	                  { className: 'a' },
	                  _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'corner_products' })
	                )
	              ),
	              _react2.default.createElement(
	                'li',
	                { onClick: this.setMenu('bundles'), className: this.state.active === 'bundles' ? 'active' : '' },
	                _react2.default.createElement(
	                  'span',
	                  { className: 'a' },
	                  _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'corner_bundles' })
	                )
	              )
	            )
	          ),
	          _react2.default.createElement(Products, { show: this.state.active === 'products', keywords: userCorner.products.reduce(this.groupKeywords, []), products: userCorner.products }),
	          _react2.default.createElement(Bundles, { show: this.state.active === 'bundles', keywords: userCorner.bundles.reduce(this.groupKeywords, []), bundles: userCorner.bundles })
	        )
	      );
	    }
	  }]);
	  ...
	  this.needReload = function (props) {
	    return !_this3.state.loading && !!_this3.props.userCorner && UserCorner.getId(props.params) !== _this3.props.userCorner.get('idUser');
	  };
	
	  this.setMenu = function (item) {
	    return function () {
	      _this3.setState({
	        active: item
	      });
	  ...
	  this.onFilter = function (filters) {
	    _this3.setState({
	      filters: filters
	    });
	  };
