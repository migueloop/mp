...
/***/ function(module, exports, __webpack_require__) {
	...
	var Users = (_dec = (0, _reactRedux.connect)(function (state) {
	  return {
	    tenant: state.get('v02').get('common').get('tenant').get('name'),
	  ...
	  function Users(props) {
	    ...
	    _this.deleteEditor = function (id_user) {
	      new _actions2.default(_this.props.tenant).Users.Editor.Delete({ id_user: id_user }).then(function (action) {
	        return _this.props.dispatch(action);
	      }).catch(function (err) {
	    ...
	    _this.validate = function (id_user) {
	      return function () {
	        new _actions2.default(_this.props.tenant).Users.Editor.Activate({
	          id_user: id_user
	    ...
	    _this.editorDetails = function () {
	      if (!_this.state.editor) {
	        return _react2.default.createElement('div', null);
	      }
	      var formattedMessage = _this.context.intl.formatMessage;
	      var company = _this.props.companies.find(function (company) {
	        return company.id == _this.state.editor.editorProfile.id_company;
	      });
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_Static2.default, { label: formattedMessage({ id: 'firstname' }), labelClassName: 'col-xs-5', wrapperClassName: 'col-xs-7', value: _this.state.editor.name }),
	          _react2.default.createElement(_Static2.default, { label: formattedMessage({ id: 'surname' }), labelClassName: 'col-xs-5', wrapperClassName: 'col-xs-7', value: _this.state.editor.lastname }),
	          _react2.default.createElement(_Static2.default, { label: formattedMessage({ id: 'email' }), labelClassName: 'col-xs-5', wrapperClassName: 'col-xs-7', value: _this.state.editor.email }),
	          _react2.default.createElement(_Static2.default, { label: formattedMessage({ id: 'telephone' }), labelClassName: 'col-xs-5', wrapperClassName: 'col-xs-7', value: _this.state.editor.phone }),
	          _react2.default.createElement('hr', null),
	          _react2.default.createElement(_Static2.default, { label: formattedMessage({ id: 'company' }), labelClassName: 'col-xs-5', wrapperClassName: 'col-xs-7', value: company.name }),
	          _react2.default.createElement(_Static2.default, { label: formattedMessage({ id: 'siret' }), labelClassName: 'col-xs-5', wrapperClassName: 'col-xs-7', value: company.siret }),
	          _react2.default.createElement(_Static2.default, { label: formattedMessage({ id: 'activity_fields' }), labelClassName: 'col-xs-5', wrapperClassName: 'col-xs-7', value: company.activity_fields.map(function (af) {
	              return af.name;
	            }).join(', ') }),
	          _react2.default.createElement(_Static2.default, { label: formattedMessage({ id: 'siret' }), labelClassName: 'col-xs-5', wrapperClassName: 'col-xs-7', value: company.platforms.map(function (platform) {
	    ...
	    _this.transform = {
	      ...
	      actions: function actions(id, rowData) {
	        var formattedMessage = _this.context.intl.formatMessage;
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            TableActions,
	            null,
	            _react2.default.createElement(TableActions.Button, { icon: 'eye-open', text: formattedMessage({ id: 'visualize' }), primary: true, onClick: function onClick() {
	                return _this.setState({ editor: rowData, modalViewEditor: true });
	              } }),
	            _react2.default.createElement(TableActions.Button, { style: { backgroundColor: '#009933' }, onClick: _this.validate(id), icon: 'ok', text: formattedMessage({ id: 'validate' }) }),
	            _react2.default.createElement(TableActions.Button, { style: { backgroundColor: '#a94442' }, onClick: function onClick() {
	                return _this.setState({ editor: rowData, modalDeleteEditor: true });
	              }, icon: 'remove', text: formattedMessage({ id: 'remove' }) })
	          )
	        );
	      },
	      company: function company(editorProfile) {
	        return _this.props.companies.find(function (c) {
	          return c.id == editorProfile.id_company;
	        }).name;
	      }
	    };
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          { data: this.props.editors.filter(function (u) {
	              return !u.activated;
	            }).map(function (editor) {
	              return _this2.props.users.find(function (u) {
	                return u.id == editor.id_user;
	              });
	            }), dtStyle: 'dark' },
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'name', title: formattedMessage({ id: 'name' }), sortable: true, md: 4 }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'email', title: formattedMessage({ id: 'email' }), sortable: true, md: 4, searchable: true }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'editorProfile', title: formattedMessage({ id: 'company' }), sortable: true, md: 3, transform: this.transform.company }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'id', title: formattedMessage({ id: 'action' }), md: 1, transform: this.transform.actions }),
	          _react2.default.createElement(_reactDatatableBootstrap.Pagination, { maxButtons: 3, itemPerPage: 10, ellipsis: false })
	        ),
	        _react2.default.createElement(
	          _Modal2.default,
	          { show: this.state.modalViewEditor, onHide: function onHide() {
	              return _this2.setState({ editor: null });
	            } },
	          _react2.default.createElement(
	            _Modal2.default.Header,
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'editor_details' })
	          ),
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { bsStyle: 'success', onClick: function onClick() {
	                  _this2.validate(_this2.state.editor.id)();_this2.setState({ editor: null });
	                } },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'validate' })
	            ),
	            _react2.default.createElement(
	              _Button2.default,
	              { bsStyle: 'primary', onClick: function onClick() {
	                  return _this2.setState({ editor: null, modalViewEditor: false });
	                } },
	        ...
	        _react2.default.createElement(
	          _Modal2.default,
	          { show: !!this.state.modalDeleteEditor, onHide: function onHide() {
	              return _this2.setState({ editor: null });
	            } },
	          _react2.default.createElement(
	            _Modal2.default.Header,
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'delete_user' })
	          ),
	          _react2.default.createElement(
	            _Modal2.default.Body,
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'confirm_delete_user' })
	          ),
	          _react2.default.createElement(
	            _Modal2.default.Footer,
	            null,
	            _react2.default.createElement(
	              _Button2.default,
	              {
	                bsStyle: 'danger',
	                onClick: function onClick() {
	                  _this2.deleteEditor(_this2.state.editor.id);
	                  _this2.setState({ editor: null, modalDeleteEditor: false });
	                }
	              },
	            ...
	            _react2.default.createElement(
	              _Button2.default,
	              { bsStyle: 'primary', onClick: function onClick() {
	                  return _this2.setState({ modalDeleteEditor: false });
	                } },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'close' })
	            )
	          )
