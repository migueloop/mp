	...
	var Detail = (_dec = (0, _connect2.default)(function (state) {
	  ...
	  _createClass(Detail, null, [{
	    ...
	    value: function getActions(tenant) {
	      ...
	      return [actions.FrontOffice.HomeCarousel.fetch()];
	    }
	  }]);
	  ...
	  function Detail(props) {
	    ...
	    _this.componentWillMount = function () {
	      _this.setState({ page: _this.props.carousel.toJS()[_this.props.routeParams.id - 1] });
	    };
	  ...
	  _createClass(Detail, [{
	    ...
	    value: function render() {
	      ...
	      var title = this.state.page.detailPagePicture === this.state.page.mainPicture ? this.state.page.title : '';
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'detail-page mp-home' },
	        _react2.default.createElement(
	          'div',
	          { className: 'detail-header-img mp-carousel' },
	          _react2.default.createElement('img', { src: '/public/uploads/carousel/' + this.state.page.detailPagePicture, alt: this.state.page.secondaryPictureALT })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'detail-content' },
	          _react2.default.createElement('h4', { className: 'detail-title', dangerouslySetInnerHTML: { __html: title } }),
	          _react2.default.createElement('div', { className: 'detail-text', dangerouslySetInnerHTML: { __html: this.state.page.content } })
	        )
	      );
	    }
	  }]);
