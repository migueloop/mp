	  ...
	  _createClass(Gdp, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'container' },
	        _react2.default.createElement('iframe', { src: 'https://sncf-bi360-config.digitaldimension.services/fichedeligne/Fiche_de_ligne/list', className: 'billing-system-offers-bo' })
	      );
	    }
	  }], [{
	    key: 'fetchData',
