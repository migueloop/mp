...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalSlideshow = (_temp2 = _class = function (_Components) {
	  _inherits(ModalSlideshow, _Components);
	  ...
	  function ModalSlideshow() {
	    ...
	    _classCallCheck(this, ModalSlideshow);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ModalSlideshow.__proto__ || Object.getPrototypeOf(ModalSlideshow)).call.apply(_ref, [this].concat(args))), _this), _this.onDrop = function (pos) {
	      return function (evt) {
	        _this.props.onUpload(pos, evt);
	      };
	    }, _this.onDelete = function (resource) {
	      return function () {
	        _this.props.onDelete(resource);
	      };
	    }, _this.onSelectFromResource = function (position) {
	      return function () {
	        _this.props.onSelect(position);
	      };
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  _createClass(ModalSlideshow, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      var slideshow = this.props.resources.map(function (resource, i) {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'div',
	                { className: 'hover-container', style: { position: 'absolute', width: '100%', height: '100%' } },
	                _react2.default.createElement('img', { src: '/public/uploads/products/' + _this2.props.product.id + '/' + resource.name,
	                  style: { maxWidth: '100%', maxHeight: '100%', position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, margin: 'auto' }
	                }),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'hover-actions', style: { backgroundColor: 'rgba(0,0,0,0.3)' } },
	                  _react2.default.createElement(
	                    'div',
	                    { style: hoverStyle },
	                    _react2.default.createElement(
	                      ...
	                      _react2.default.createElement(
	                        _Button2.default,
	                        { bsStyle: 'info', onClick: _this2.onSelectFromResource(i + 1) },
	                    ...
	                    _react2.default.createElement(
	                      ...
	                      _react2.default.createElement(
	                        _Button2.default,
	                        { bsStyle: 'danger', onClick: _this2.onDelete(resource) },
	      ...
	      if (slideshow.length < 6) {
	        slideshow.push(_react2.default.createElement(
	          _Col2.default,
	          { xs: 4, key: 'newSlide', style: { cursor: 'pointer' } },
	          _react2.default.createElement(
	            'div',
	            { className: 'thumbnail', style: { cursor: 'pointer' } },
	            _react2.default.createElement(
	              'div',
	              { style: { position: 'relative', width: '100%', paddingBottom: '100%' } },
	              _react2.default.createElement(
	                'div',
	                { className: 'hover-container', style: { position: 'absolute', width: '100%', height: '100%' } },
	                _react2.default.createElement('img', { src: '/public/images/placeholders/image_add.png',
	                  style: { maxWidth: '100%', maxHeight: '100%', position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, margin: 'auto' }
	                }),
	                _react2.default.createElement(
	                  'div',
	                  ...
	                  _react2.default.createElement(
	                    'div',
	                    { style: _extends({}, hoverStyle, { marginTop: -44 }) },
	                    _react2.default.createElement(
	                      _Row2.default,
	                      null,
	                      _react2.default.createElement(
	                        _Button2.default,
	                        { bsStyle: 'info', onClick: this.onSelectFromResource(slideshow.length + 1) },
	                        _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'select' })
	                      )
	                    ),
	                    _react2.default.createElement(
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _Modal2.default.Title,
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'images' })
	          )
	        ),
	        _react2.default.createElement(
	          _Modal2.default.Body,
	...
	var _components = { default: ModalSlideshow };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalSlideshow = __webpack_require__(1121);
	
	var _modalSlideshow2 = _interopRequireDefault(_modalSlideshow);
	...
	var save = function save(key) {
	  return function (data) {
	    return console.log('SAVING::', key, '::', data);
	  };
	};
	var update = function update(key) {
	  return function (data) {
	    return console.log('UPDATING::', key, '::', data);
	  };
	};
	...
	var Summary = (_temp = _class = function (_Components) {
	  ...
	  function Summary(props) {
	    ...
	    _this.selectFromResources = function (position) {
	      _this.setState({ selectResource: position });
	    };
	    ...
	    _this.onSelectResource = function (resource) {
	      var product = {
	        ...
	        resource: {
	          id: resource.id,
	          home_order: _this.state.selectResource
	        }
	      };
	      new _actions2.default(_this.props.tenant).Products.AddSlideShowFromResource(product).then(_this.props.dispatch);
	      _this.setState({ selectResource: 0 });
	    };
	
	    _this.uploadPhoto = function (position, files) {
	      new _actions2.default(_this.props.tenant).Products.AddSlideShow({
	        id: _this.props.product.toJS().id,
	        resource: { home_order: position, file: files[0] }
	      }).then(_this.props.dispatch);
	    };
	
	    _this.deleteFromSlideshow = function () {
	      var resource = _this.state.resourceToDelete;
	      _this.setState({ resourceToDelete: null });
	      new _actions2.default(_this.props.tenant).Products.DeleteFromSlideshow({ id: _this.props.product.toJS().id, resource: resource }).then(_this.props.dispatch);
	    };
	
	    _this.removeKeyword = function (item) {
	      return function () {
	        var corners = _this.props.product.toJS().domains.filter(function (clickedItem) {
	          return item.value !== clickedItem.id;
	        });
	        var keywords = corners.reduce(function (kwords, corner) {
	          return kwords.concat(_this.props.product.toJS().keywords.filter(function (k) {
	            return !!_this.props.domains.toJS().find(function (c) {
	              return parseInt(c.id, 10) === parseInt(corner.id, 10);
	            }).keywords.find(function (k2) {
	              return parseInt(k2.id, 10) === parseInt(k.id, 10);
	            });
	          }));
	        }, []);
	    ...
	    _this.handleSelect = function (selectedIndex, e) {
	      _this.setState({
	        index: selectedIndex,
	  ...
	  _createClass(Summary, [{
	    ...
	    value: function componentDidMount() {
	      Promise.all(Summary.getActions(this.props.tenant, this.props.params, this.props.location.query, this.props.user).map(this.props.dispatch));
	    }
	  }, {
	    key: 'getHomeImages',
	    value: function getHomeImages(product) {
	      return product.resources.filter(function (p) {
	        return p.home_order !== null;
	      }).sort(function (a, b) {
	    ...
	    value: function render() {
	      ...
	      var _map = [_modalSlideshow2.default, _confirmationPopup2.default, _modalSelectResource2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 3),
	          ModalSlideshow = _map2[0],
	          ConfirmationPopup = _map2[1],
	          ModalSelectResource = _map2[2];
	
	      var product = this.props.product.toJS();
	      var homeImages = this.getHomeImages(product);
	      ...
	      var oSlides = homeImages.map(function (resource, index) {
	        return _react2.default.createElement(
	          'div',
	          { onClick: function onClick() {
	              return _this2.setState({ showModalEditCarousel: true });
	            }, style: { cursor: 'pointer' } },
	          _react2.default.createElement('img', { src: '/public/uploads/products/' + product.id + '/' + resource.name })
	        );
	      });
	
	      if (oSlides.length === 0) {
	        oSlides = [_react2.default.createElement(
	          _CarouselItem2.default,
	          { key: 'new', onClick: function onClick() {
	              return _this2.setState({ showModalEditCarousel: true });
	            }, style: { cursor: 'pointer' } },
	          _react2.default.createElement('img', { src: '/public/images/placeholders/product.png' })
	        )];
	      }
	
	      var multiselectCornerProperties = {
	        onBlur: save(['corners', 'keywords']),
	        options: this.props.domains.toJS().map(function (c) {
	          return { label: c.name, value: c.id };
	        }),
	        values: product.domains.map(function (c) {
	          return { label: c.name, value: c.id };
	        }),
	        onValuesChange: function onValuesChange(corners, callback) {
	          update('corners')(corners.map(function (c) {
	        ...
	        renderValue: function renderValue(item) {
	          return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'span',
	              { onClick: _this2.removeKeyword(item) },
	              item.label
	            )
	          );
	        }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _Col2.default,
	          { md: 4, className: 'no-padding-left' },
	          _react2.default.createElement(
	            Carousel,
	            {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'corners' })
	            ),
	            _react2.default.createElement(_reactSelectize.MultiSelect, _extends({ className: 'cornersMultiselect' }, multiselectCornerProperties))
	          ),
	          _react2.default.createElement(
	            'label',
	            { style: { width: '100%', fontWeight: 'normal' } },
	            ...
	            _react2.default.createElement(_reactSelectize.MultiSelect, { className: 'keywordsMultiselect', onBlur: save('keywords'),
	              options: product.domains.reduce(function (keywords, productCorner) {
	                var domain = _this2.props.domains.toJS().find(function (c) {
	                  return parseInt(c.id, 10) === parseInt(productCorner.id, 10);
	                });
	                if (!domain) {
	                  return keywords;
	                }
	                ...
	                return keywords.concat(domain.keywords.reduce(function (prev, keyword) {
	                  if (!keywords.find(function (k) {
	                    return parseInt(k.value, 10) === parseInt(keyword.id, 10);
	                  })) {
	              ...
	              renderValue: function renderValue(item) {
	                var html = _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'span',
	                    { onClick: function onClick() {
	                        update('keywords')(product.keywords.filter(function (clickedItem) {
	                          return item.value !== clickedItem.id;
	                        }));
	                      } },
	                    item.label
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_Input2.default, { name: 'baseline', type: 'text', value: product.baseline,
	              onChange: function onChange(_ref) {
	                var target = _ref.target;
	                update('baseline')(target.value);
	              },
	        ...
	        _react2.default.createElement(ModalSlideshow, _extends({
	          show: this.state.showModalEditCarousel,
	          onSelect: this.selectFromResources,
	          onUpload: this.uploadPhoto,
	          onDelete: function onDelete(resource) {
	            return _this2.setState({ resourceToDelete: resource });
	          },
	          resources: homeImages,
	          hide: function hide() {
	            return _this2.setState({ showModalEditCarousel: false });
	          },
	          product: product
	        }, this.props)),
	        _react2.default.createElement(
	          ConfirmationPopup,
	          {
	            show: !!this.state.resourceToDelete, onHide: function onHide() {
	              return _this2.setState({ resourceToDelete: null });
	            },
	        ...
	        _react2.default.createElement(ModalSelectResource, _extends({
	          show: this.state.selectResource > 0, hide: function hide() {
	            return _this2.setState({ selectResource: 0 });
	          },
	          onSelect: this.onSelectResource,
	          resources: product.resources.filter(function (p) {
	            return !p.home_order && p.type.startsWith('image');
	          })
	        }, this.props)),
	    ...
	    value: function getActions(tenant) {
	      ...
	      return [actions.BackOffice.Domains.fetch()];
	    }
	  }]);
