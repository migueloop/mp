...
/***/ function(module, exports, __webpack_require__) {
	...
	var VerticalColFeature = function (_Components) {
	  _inherits(VerticalColFeature, _Components);
	
	  function VerticalColFeature() {
	    _classCallCheck(this, VerticalColFeature);
	
	    return _possibleConstructorReturn(this, (VerticalColFeature.__proto__ || Object.getPrototypeOf(VerticalColFeature)).apply(this, arguments));
	  }
	
	  _createClass(VerticalColFeature, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { key: this.props.key, className: 'feature', style: { height: this.props.heightMax > 5 ? this.props.heightMax : 'initial' } },
	        _react2.default.createElement(
	          'h4',
	          null,
	          this.props.feature.name
	        ),
	        _react2.default.createElement('div', { className: 'description', dangerouslySetInnerHTML: { __html: this.props.feature.description } })
	      );
	    }
	  }]);
	
	  return VerticalColFeature;
	}(_baseComponent2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _verticalColFeature = __webpack_require__(701);
	
	var _verticalColFeature2 = _interopRequireDefault(_verticalColFeature);
	...
	var Details = function (_Components) {
	  _inherits(Details, _Components);
	  ...
	  _createClass(Details, [{
	    key: 'removeClick',
	    value: function removeClick(evt) {
	      evt.preventDefault();
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      if (!product.availableFeatures.find(function (productFeatures) {
	        return _features.PRODUCT_FEATURES.id === productFeatures.idFeature;
	      })) {
	        return _react2.default.createElement(
	          'div',
	          null,
	      ...
	      var _map = [_verticalColFeature2.default].map(function (Component) {
	        return Component.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          VerticalColFeature = _map2[0];
	
	      var productSpecification = {};
	      var productSpecificationHTML = '';
	
	      var languages = product.languages.map(function (language) {
	        return '[' + language.abbreviation.toUpperCase() + ']';
	      });
	
	      if (product.specification) {
	        productSpecification = product.resources.find(function (resource) {
	          return resource.id === product.specification;
	        });
	        productSpecificationHTML = _react2.default.createElement(
	          'p',
	          { className: 'specs', onClick: this.openModal },
	          _react2.default.createElement(
	            _reactRouter.Link,
	            { to: '#specs', onClick: this.removeClick },
	            _react2.default.createElement('i', { className: 'icono icono-pdf' }),
	            _react2.default.createElement(
	              'span',
	              { className: 'text' },
	              productSpecification.nameCustom || productSpecification.name
	            )
	          )
	        );
	      }
	
	      var productFeatures = product.features.map(function (feature, index) {
	        return _react2.default.createElement(
	          _reactBootstrap.Col,
	          { key: index, sm: 6, md: 4 },
	          _react2.default.createElement(VerticalColFeature, { feature: feature, heightMax: _this2.state.maxHeight })
	        );
	      });
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'mp-tab mp-tab-features' },
	        _react2.default.createElement(
	          'div',
	          { className: 'snippet' },
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'p',
	                { className: 'languages' },
	                _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'com_languages' }),
	                languages
	              )
	            ),
	            _react2.default.createElement(
	        ...
	        _react2.default.createElement(_modalBase2.default, { show: this.state.showModal,
