...
/***/ function(module, exports, __webpack_require__) {
	...
	var editor = (_temp = _class = function (_Components) {
	  ...
	  function editor(props) {
	    ...
	    _this.onClickThumbnail = function (logoUrl, nKey) {
	      return function (e) {
	        if (!logoUrl) _this.setState({ updateItem: nKey, showModalFilterProducts: true });
	      };
	    };
	
	    _this._createComponentItem = function (sLogoUrl, sComponentName, nComponentId, nKey) {
	      var hoverActions = _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { bsStyle: 'info', onClick: function onClick() {
	                return _this.setState({ updateItem: nKey, showModalFilterProducts: true });
	              } },
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'modify' })
	          ),
	          _react2.default.createElement(
	            _Button2.default,
	            { bsStyle: 'danger', onClick: _this.onDeleteComponent(nComponentId, nKey) },
	      ...
	      return _react2.default.createElement(
	        _Col2.default,
	        { xs: 6, sm: 3, md: 3, lg: 3, key: nKey },
	        _react2.default.createElement(
	          'label',
	          { className: 'text-center', style: { display: 'block', marginBottom: '20px' } },
	          sComponentName || _this.format({ id: 'select_component' })
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'thumb-square ' + (!sLogoUrl && 'thumb-select-clickable'),
	            style: { backgroundImage: 'url(' + (sLogoUrl || _constants.ITEM.PLACEHOLDERS.PICTURES.ADD_NEW.URL) + ')' },
	            onClick: _this.onClickThumbnail(sLogoUrl, nKey)
	          },
	    ...
	    _this.setComponentsItems = function () {
	      var aComponents = [];
	
	      var _loop = function _loop(index) {
	        // match if current component must be shown in the current position of the components
	        var oComponent = _this.props.bundle.components.find(function (bc) {
	          return bc && +bc.show_order === index;
	        });
	        // if match, set URL of the image to show and meta information
	        oComponent ? aComponents.push(_this._createComponentItem(oComponent.logo, oComponent.name, oComponent.id, index)) : aComponents.push(_this._createComponentItem('', '', 0, index));
	      };
	
	      for (var index = 0; index < _constants.ITEM.BUNDLE.COMPONENTS.NUMBER; index++) {
	        _loop(index);
	      }
	    ...
	    _this.onAddComponent = function (oSelectedComponent) {
	      var oComponent = _extends({}, oSelectedComponent);
	
	      oComponent.show_order = _this.state.updateItem;
	      _this.props.onAddComponent(oComponent);
	      _this.toggleModalFilterProducts();
	    };
	
	    _this.onDeleteComponent = function (nComponentId, nKey) {
	      return function (event) {
	        event.preventDefault();
	        _this.props.onDeleteComponent(nComponentId, nKey);
	      };
	    };
	
	    _this.toggleModalFilterProducts = function () {
	      _this.setState({ showModalFilterProducts: !_this.state.showModalFilterProducts });
	    };
	  ...
	  _createClass(editor, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_modalFilterProducts2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          ModalFilterProducts = _map2[0];
	
	      var components = this.setComponentsItems();
	      return _react2.default.createElement(
	        _Row2.default,
	        null,
	        _react2.default.createElement(
	          _Col2.default,
	          { md: 10, className: 'select-bundle-component-title col-md-offset-1' },
	          _react2.default.createElement(
	            'h3',
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'bundle_compose_four' }),
	  ...
	  onAddComponent: _react2.default.PropTypes.func.isRequired,
	  onDeleteComponent: _react2.default.PropTypes.func.isRequired
	}, _temp);
	...
	var _components = { default: (0, _connect2.default)(stateToProps)(editor) };
