...
/***/ function(module, exports, __webpack_require__) {
	...
	var _permissions = __webpack_require__(654);
	...
	var RoleList = (_temp = _class = function (_Components) {
	  _inherits(RoleList, _Components);
	
	  function RoleList(props) {
	    _classCallCheck(this, RoleList);
	
	    var _this = _possibleConstructorReturn(this, (RoleList.__proto__ || Object.getPrototypeOf(RoleList)).call(this, props));
	
	    _this.transform = {
	      actions: function actions(id, rowData, index) {
	        ...
	        return _react2.default.createElement(
	          TableActions,
	          null,
	          _react2.default.createElement(TableActions.Button, {
	            type: 'edit',
	            onClick: function onClick() {
	              _this.navigate('/admin/users/acl/edit/' + id + '/ACL');
	            }
	          })
	        );
	      },
	    ...
	    _this.create = function () {
	      if (!_this.state.create.name) {
	        return;
	      }
	      new _actions2.default(_this.props.tenant).BackOffice.Acl.create(_this.state.create).then(function (action) {
	        _this.props.dispatch(action);
	        setTimeout(function () {
	          _this.navigate('/admin/users/acl/edit/' + action.payload.id + '/ACL');
	        }, 10);
	      });
	    };
	  ...
	  _createClass(RoleList, [{
	    ...
	    value: function render() {
	      ...
	      var roles = this.props.roles.toJS().map(function (role) {
	        return _extends({}, role, {
	          users: _this2.props.users.toJS().filter(function (user) {
	            return user.id_role === role.id;
	          })
	        });
	      });
	      var formattedMessage = this.context.intl.formatMessage;
	
	      var _map3 = [_contentHeader2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map4 = _slicedToArray(_map3, 1),
	          ContentHeader = _map4[0];
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ContentHeader,
	          { contentTitle: 'Users: Role Management' },
	          _react2.default.createElement(
	            _Button2.default,
	            { onClick: function onClick() {
	            ...
	            '+ ',
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'create_role' })
	          )
	        ),
	        _react2.default.createElement(
	          _reactDatatableBootstrap.DataTable,
	          { data: roles, dtStyle: 'dark' },
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'name', title: formattedMessage({ id: 'name' }), sortable: true, md: 4, searchable: true }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'permissions', title: formattedMessage({ id: 'permissions' }), md: 3, transform: this.transform.total }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'users', title: formattedMessage({ id: 'users' }), md: 3, transform: this.transform.total }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'id', title: formattedMessage({ id: 'action' }), md: 2, transform: this.transform.actions }),
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { close: true },
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'new_role_modal_title' })
	          ),
	          _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'label',
	                    null,
	                    _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'role_name' })
	                  ),
	                  _react2.default.createElement(_Input2.default, { type: 'text', value: this.state.create.name,
	                    onChange: function onChange(_ref) {
	                      var value = _ref.target.value;
	                      return _this2.setState({ create: _extends({}, _this2.state.create, { name: value }) });
	                    }
	                  })
	                )
	              ),
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'label',
	                    null,
	                    _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'clone_role' })
	                  ),
	                  _react2.default.createElement(
	                    'select',
	                    { style: { display: 'block', width: '100%' }, value: this.state.create.cloneRole,
	                      onChange: function onChange(_ref2) {
	                        var value = _ref2.target.value;
	                        return _this2.setState({ create: _extends({}, _this2.state.create, { cloneRole: value }) });
	                      }
	                    },
	                    _react2.default.createElement(
	                      'option',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _Button2.default,
	              { bsStyle: 'primary', onClick: this.create },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'next' })
	            )
	          )
	        )
	      );
