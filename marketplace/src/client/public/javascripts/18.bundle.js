...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assignButton = __webpack_require__(698);
	
	var _assignButton2 = _interopRequireDefault(_assignButton);
	...
	var ActionsColumn = function (_Components) {
	  _inherits(ActionsColumn, _Components);
	  ...
	  function ActionsColumn(props) {
	    ...
	    _this.getOfferView = function (offer) {
	      return _react2.default.createElement(
	        _reactBootstrap.Col,
	        { md: 4, className: 'billing-offer' },
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'ul',
	            { className: 'features' },
	            offer.products.map(function (product) {
	              return _react2.default.createElement(
	                'li',
	                null,
	                product.name
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'price' },
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_subscription',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { bsStyle: 'primary', onClick: function onClick() {
	                  _this.setState({ subscribe: '' + offer.links.subscribe });
	                } },
	              'Subscribe'
	            )
	          )
	  ...
	  _createClass(ActionsColumn, [{
	    ...
	    value: function render() {
	      ...
	      var nProductCommentsNumber = 0;
	
	      // Calculate product rating
	      var oProductTotalRating = 4;
	
	      // Check if we have any rating in order to show it or show another string
	      // TODO: round to .5?
	      var sProductRating = oProductTotalRating.ratingsNumber > 0 ? _react2.default.createElement(
	        'span',
	        { className: 'value p-rating' },
	        oProductTotalRating.totalRatings / oProductTotalRating.ratingsNumber
	      ) / _react2.default.createElement(
	        'span',
	        { className: 'best p-best' },
	        _constants.PRODUCT.RATINGS.MAXRATING
	      ) : _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_not_rated' });
	
	      var _map = [_assignButton2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          AssignButton = _map2[0];
	
	      // TODO: why upper/lower case??! className -> lower, other -> none (done in CSS)
	
	
	      var oProductType = _constants.PRODUCT.TYPEINFO[product.type];
	
	      // OS
	      /* TODO: require OS name (for icon) and alt="" */
	      var osLinks = product.links.sort(function (a, b) {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _reactRouter.Link,
	            { to: link.url, rel: 'external' },
	            _react2.default.createElement('i', { className: 'icono icono-os' }),
	            _react2.default.createElement(
	              'span',
	              { className: 'text' },
	              'OS'
	      ...
	      switch (oProductType.title) {
	        case 'product_mobileapp':
	          productTitle = _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_mobileapp' });
	          break;
	        case 'product_saas':
	          productTitle = _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_saas' });
	          break;
	        case 'product_material':
	          productTitle = _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_material' });
	          break;
	        case 'product_service':
	          productTitle = _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_service' });
	          break;
	        default:
	      ...
	      if (product.offers && product.offers.length > 0) {
	        (function () {
	          var bestOffer = product.offers[0];
	          bestOffer = product.offers.reduce(function (bOffer, offer) {
	            if (offer.price < bestOffer.price) {
	              return offer;
	            }
	            return bOffer;
	          }, bestOffer);
	          var _bestOffer = bestOffer,
	              price = _bestOffer.price,
	              unitRecurrence = _bestOffer.unitRecurrence;
	
	          subscribeButton = _react2.default.createElement(
	            _reactRouter.Link,
	      ...
	      var subscribe = product.offers && product.offers.map(this.getOfferView);
	
	      if (this.state.subscribe) {
	        subscribe = _react2.default.createElement('iframe', { src: '' + this.state.subscribe,
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'type' },
	          _react2.default.createElement('i', { className: 'icono icono-' + oProductType.class }),
	          _react2.default.createElement(
	            'h4',
	            { className: 'category' },
	            productTitle
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _reactRouter.Link,
	            { to: '#like', onClick: function onClick(evt) {
	                return evt.preventDefault();
	              }, className: 'btn-like like ' + (!!this.props.userLogged ? 'hidden' : 'none') },
	            _react2.default.createElement('i', { className: 'icono icono-like' }),
	            _react2.default.createElement(
	              'span',
	              { className: 'text' },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_like' })
	            )
	          ),
	          _react2.default.createElement(
	            'p',
	            { className: 'review hreview h-review' },
	            _react2.default.createElement(
	              'span',
	              { className: 'rating' },
	              sProductRating
	            ...
	            _react2.default.createElement(
	              'span',
	              { className: 'comments ' + (nProductCommentsNumber ? '' : 'hidden') },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_comments',
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'actions' },
	          this.props.userLogged && _react2.default.createElement(AssignButton, { user: this.props.user, product: this.props.product }),
	          subscribeButton,
	          _react2.default.createElement(
	            _reactRouter.Link,
	            { to: '#contact', onClick: this.props.openContactUsModal, className: 'contact btn btn-default' },
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_contact' })
	          )
	        ),
	        _react2.default.createElement(
	          'ul',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { onClick: function onClick(evt) {
	                  return evt.preventDefault();
	                }, to: '#community', rel: 'external', className: 'community' },
	              _react2.default.createElement('i', { className: 'icono icono-community' }),
	              _react2.default.createElement(
	                'span',
	                { className: 'text' },
	                _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_community' })
	              )
	            )
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          { bsSize: 'lg', show: this.state.openIframe, onHide: function onHide() {
	              _this2.setState({ openIframe: false, subscribe: null });
	            } },
	          _react2.default.createElement(
	            _reactBootstrap.Modal.Header,
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_subscribe' })
	          ),
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _optionForms = __webpack_require__(702);
	
	var _optionForms2 = _interopRequireDefault(_optionForms);
	...
	var AssignProductButton = (_temp = _class = function (_Component) {
	  _inherits(AssignProductButton, _Component);
	
	  function AssignProductButton(props) {
	    _classCallCheck(this, AssignProductButton);
	
	    var _this = _possibleConstructorReturn(this, (AssignProductButton.__proto__ || Object.getPrototypeOf(AssignProductButton)).call(this, props));
	
	    _this.onClick = function () {
	      var item = _this.props.product.toJS();
	      var AssignmentFormOption = _optionForms2.default.get(item.idAssignmentOptionForm, _this.props.tenant);
	      return _this.setState({
	        modalContent: _react2.default.createElement(AssignmentFormOption, { onSubmit: _this.createAssignation })
	      });
	    };
	
	    _this.createAssignation = function (assignmentOrderOptions) {
	      var product = _this.props.product.toJS();
	      var user = _this.props.user.toJS();
	      var assignmentProductProps = {
	      ...
	      var assignment = {
	        ...
	        id_assigned_by: _this.props.user.id,
	        assigned_to_info: assignnedToInfo,
	        items: [assignmentProductProps],
	        assignmentOrderOptions: assignmentOrderOptions
	      };
	
	      // TODO: Change to V2!
	      var actions = new _actions2.default(_this.props.tenant);
	      actions.Assignments.Create(assignment).then(function (action) {
	        return _this.props.dispatch(action);
	      }).then(function (action) {
	        console.log('UserNotifications::action', action);
	        return Promise.resolve(action);
	      }).then(function (action) {
	        return actions.UserNotifications.createAssignmentPublicationRequestNotification({ currentUserId: _this.props.user.toJS().id, assignmentId: action.assignment.id });
	      }).then(function (action) {
	        return _this.props.dispatch(action);
	      }).then(function () {
	  ...
	  _createClass(AssignProductButton, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'buy', style: { cursor: 'pointer' }, onClick: this.onClick },
	          _react2.default.createElement(
	            'p',
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_buy' })
	          )
	        ),
	        _react2.default.createElement(
	          _Modal2.default,
	          { show: !!this.state.modalContent, onHide: this.hideModal },
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = function (_Components) {
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      var product = this.props.product.toJS();
	      var productCategories = product.domains.map(function (domain) {
	        return _react2.default.createElement(
	          'span',
	          { className: 'category', key: domain.id },
	          domain.name
	        );
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: '/user-corner/' + product.owner.alias },
	              product.owner.title
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: '/product/' + product.alias, className: 'url u-url', rel: 'product' },
	              product.name
	            )
	          ),
	          _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lineForm = __webpack_require__(704);
	
	var _lineForm2 = _interopRequireDefault(_lineForm);
	
	var _lineForm3 = __webpack_require__(705);
	
	var _lineForm4 = _interopRequireDefault(_lineForm3);
	
	var _default = __webpack_require__(703);
	...
	var TenantProxy = function () {
	  ...
	  _createClass(TenantProxy, null, [{
	    key: 'get',
	    value: function get(id, tenant) {
	      var _map = [_lineForm2.default, _lineForm4.default, _default2.default].map(function (cmpt) {
	        return cmpt.get(tenant);
	      }),
	          _map2 = _slicedToArray(_map, 3),
	          AssignmentOrderOptionsForm1 = _map2[0],
	          AssignmentOrderOptionsForm2 = _map2[1],
	          Default = _map2[2];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LineOptionsForm = function (_Components) {
	  ...
	  function LineOptionsForm() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LineOptionsForm.__proto__ || Object.getPrototypeOf(LineOptionsForm)).call.apply(_ref, [this].concat(args))), _this), _this.onSubmit = function (e) {
	      e.preventDefault();
	  ...
	  _createClass(LineOptionsForm, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'form',
	        { id: 'line_form_2', onSubmit: this.onSubmit, className: 'center-block', style: { width: '300px' } },
	        _react2.default.createElement(
	          'h4',
	          null,
	          _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'no_option_info_needed' })
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LineOptionsForm = (_temp2 = _class = function (_Components) {
	  _inherits(LineOptionsForm, _Components);
	  ...
	  function LineOptionsForm() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LineOptionsForm.__proto__ || Object.getPrototypeOf(LineOptionsForm)).call.apply(_ref, [this].concat(args))), _this), _this.onSubmit = function (e) {
	      e.preventDefault();
	      _this.props.onSubmit((0, _formSerialize2.default)(e.target));
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  _createClass(LineOptionsForm, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'form',
	        { id: 'line_form_1', onSubmit: this.onSubmit, className: 'center-block', style: { width: '300px' } },
	        _react2.default.createElement(
	          'h3',
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = function (_Components) {
	  _inherits(Tabs, _Components);
	  ...
	  function Tabs() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call.apply(_ref, [this].concat(args))), _this), _this.onSelect = function (tab) {
	      return function () {
	        _this.props.onSelect(tab);
	      };
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  _createClass(Tabs, [{
	    ...
	    value: function render() {
	      ...
	      var product = this.props.product.toJS();
	      var tabsBaseUrl = '/product/' + product.alias;
	
	      var productTabs = _features.PRODUCT_AVAILABLE_FEATURES.reduce(function (tabs, PRODUCT_FEATURE) {
	        if (product.availableFeatures.find(function (availableFeature) {
	          return availableFeature.idFeature === PRODUCT_FEATURE.id;
	        })) {
	          return tabs.concat([_react2.default.createElement(
	            'li',
	            { key: PRODUCT_FEATURE.id },
	            _this2.props.onSelect ? _react2.default.createElement(
	              'a',
	              { href: '#', className: _this2.props.active === PRODUCT_FEATURE.id ? 'active' : '', onClick: _this2.onSelect(PRODUCT_FEATURE.id) },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: PRODUCT_FEATURE.id })
	            ) : _react2.default.createElement(
	              _reactRouter.Link,
	              { activeClassName: 'active', to: tabsBaseUrl + '/' + PRODUCT_FEATURE.route },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: PRODUCT_FEATURE.id })
	            )
	          )]);
	        }
	      ...
	      return _react2.default.createElement(
	        'nav',
	        { className: 'mp-menu mp-product-tabs' },
	        _react2.default.createElement(
	          'ul',
	          { className: 'links' },
	          productTabs
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tabs = __webpack_require__(710);
	
	var _tabs2 = _interopRequireDefault(_tabs);
	
	var _actionsColumn = __webpack_require__(697);
	...
	var Product = function (_Components) {
	  ...
	  function Product() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Product.__proto__ || Object.getPrototypeOf(Product)).call.apply(_ref, [this].concat(args))), _this), _this.load = function (props) {
	      return Promise.all(Product.getActions(_this.props.tenant, _this.props.params).concat(Product.getClientActions(_this.props.tenant, _this.props.params)).map(props.dispatch));
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	  ...
	  _createClass(Product, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      // FIXME: Only search product once we are looking for the product on render too and i other methods
	      /* const product = this.props.products.toJS().find(p => parseInt(p.id, 10) === parseInt(this.state.id, 10));
	      if (product.offer === undefined && product.id_billing) {
	        new Actions(this.props.tenant).Products.fetchOffers(product.id_billing).then(this.props.dispatch);
	      }*/
	      // set the initial tab rendered depending of the tabs available
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      var _map = [_header2.default, _tabs2.default, _actionsColumn2.default].map(function (Cmpt) {
	        return Cmpt.get(tenant);
	      }),
	          _map2 = _slicedToArray(_map, 3),
	          Header = _map2[0],
	          Tabs = _map2[1],
	          ActionsColumn = _map2[2];
	
	      return _react2.default.createElement(
	        'article',
	        { className: 'mp-product product-industrie' },
	        _react2.default.createElement(
	          'div',
	          { className: 'container' },
	          _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    _reactBootstrap.Col,
	                    { sm: 6, md: 7 },
	                    _react2.default.createElement(Tabs, { loc: this.props.location })
	                  )
	                )
	              ),
	              this.props.children
	            ...
	            _react2.default.createElement(
	              _reactBootstrap.Col,
	              { md: 3 },
	              _react2.default.createElement(ActionsColumn, { product: this.props.product })
	            )
	          )
	        )
	      );
	    ...
	    value: function getActions(tenant) {
	      ...
	      console.log("dfjaslfhjahñkjsafksa sleectionado el producto con id" + Product.getId(params));
	      return [actions.FrontOffice.Products.fetchOne(Product.getId(params))];
	    }
	  }, {
	    key: 'getClientActions',
	    value: function getClientActions(tenant, params) {
	      var actions = new _flux.Actions(tenant);
	      return [actions.FrontOffice.Products.fetchOffers(Product.getId(params))];
	    }
	  }]);
	...
	var _components = { default: connector(Product) };
