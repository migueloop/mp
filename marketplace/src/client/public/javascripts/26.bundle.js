...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getProductType = exports.getProductResourceURL = exports.getProductRating = exports.getProductPlatformClass = exports.getProductGalleryImages = exports.getProductCommentsNumber = exports.getProductByAlias = undefined;
	...
	var getProductByAlias = exports.getProductByAlias = function getProductByAlias(aProducts, sAlias) {
	  return aProducts.find(function (product) {
	    return product.alias === sAlias;
	  });
	};
	
	var getProductCommentsNumber = exports.getProductCommentsNumber = function getProductCommentsNumber(aProductComments) {
	  return aProductComments.reduce(function (accumulatedCommentsNumber, currentComment) {
	    return currentComment.comment ? accumulatedCommentsNumber + 1 : 0;
	  }, 0);
	};
	
	var getProductGalleryImages = exports.getProductGalleryImages = function getProductGalleryImages(aResources, nProductId) {
	  var aImages = aResources.filter(function (oResource) {
	    return oResource.home_order !== null;
	  });
	
	  aImages.sort(function (a, b) {
	    return +(a.home_order > b.home_order) || +(a.home_order === b.home_order) - 1;
	  });
	  var aGalleryImages = aImages.map(function (oImage) {
	    var galleryImage = {
	...
	var getProductPlatformClass = exports.getProductPlatformClass = function getProductPlatformClass(sProductPlatform) {
	  switch (sProductPlatform) {
	    case _constants.PRODUCT.PLATFORM.ANDROID:
	      return 'android';
	    case _constants.PRODUCT.PLATFORM.WINDOWS:
	      return 'microsoft';
	    case _constants.PRODUCT.PLATFORM.IOS:
	      return 'ios';
	    case _constants.PRODUCT.PLATFORM.WEB:
	      return 'map-marker';
	    default:
	      return 'envelope';
	  }
	...
	var getProductRating = exports.getProductRating = function getProductRating(aProductRatings) {
	  return aProductRatings.reduce(function (accumulatedRating, currentRating, index) {
	    return { totalRatings: accumulatedRating + currentRating.rating,
	      ratingsNumber: index + 1 };
	  }, 0);
	};
	
	var getProductResourceURL = exports.getProductResourceURL = function getProductResourceURL(productId, resourceFile) {
	  return '/public/uploads/products/' + productId + '/' + resourceFile;
	};
	
	// For the front end we have three types of product:
	// They are either line or device and then everything else is support.
	var getProductType = exports.getProductType = function getProductType(inputType) {
	  var outputType = _constants.ITEM.TYPES.SUPPORT;
	  if (inputType === _constants.ITEM.TYPES.MATERIAL) {
	    outputType = _constants.ITEM.TYPES.MATERIAL;
	  }
	  if (inputType === 'MaterialNDevice') {
	    outputType = 'device';
	  }
	  if (inputType === _constants.ITEM.TYPES.LINE) {
	    outputType = _constants.ITEM.TYPES.LINE;
	  }
	  return outputType;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.setModalOptions = exports.getResourceType = undefined;
	
	var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
	
	var _constants = __webpack_require__(38);
	
	var getResourceType = exports.getResourceType = function getResourceType(sResourceType) {
	  if (sResourceType) {
	    if (sResourceType.includes(_constants.PRODUCT.RESOURCE.APPLICATION)) {
	      return _constants.MODAL.CONTENT.APPLICATION;
	    } else if (sResourceType.includes(_constants.PRODUCT.RESOURCE.FORM)) {
	      return _constants.MODAL.CONTENT.FORM;
	    } else if (sResourceType.includes(_constants.PRODUCT.RESOURCE.IMAGE)) {
	      return _constants.MODAL.CONTENT.IMAGE;
	    } else if (sResourceType.includes(_constants.PRODUCT.RESOURCE.VIDEO)) {
	      return _constants.MODAL.CONTENT.VIDEO;
	    }
	  }
	};
	
	var setModalOptions = exports.setModalOptions = function setModalOptions(oModalOptions, sFormToShow, sModalType, bShow, fHide, oContentResource, nItemId) {
	  oModalOptions.resourceSpecification = _extends({}, oContentResource);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _document = __webpack_require__(576);
	
	var _document2 = _interopRequireDefault(_document);
	
	var _image = __webpack_require__(579);
	
	var _image2 = _interopRequireDefault(_image);
	
	var _form = __webpack_require__(578);
	
	var _form2 = _interopRequireDefault(_form);
	
	var _video = __webpack_require__(580);
	
	var _video2 = _interopRequireDefault(_video);
	
	var _product = __webpack_require__(427);
	
	var _modal = __webpack_require__(465);
	
	var _constants = __webpack_require__(38);
	
	var _send = __webpack_require__(487);
	
	var _send2 = _interopRequireDefault(_send);
	
	var _fileDownload = __webpack_require__(484);
	
	var _fileDownload2 = _interopRequireDefault(_fileDownload);
	
	var _viewModels = __webpack_require__(581);
	
	var models = _interopRequireWildcard(_viewModels);
	...
	var ModalBase = (_temp = _class = function (_Components) {
	  _inherits(ModalBase, _Components);
	  ...
	  _createClass(ModalBase, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var sComponentToLoad = _react2.default.createElement(
	        'h4',
	        null,
	        _constants.MODAL.MESSAGE.ERROR.CONTENT.NO_RESOURCE_FOUND
	      );
	      var sModalContentType = void 0;
	      var sResourceURL = void 0;
	      var sTitle = _constants.MODAL.MESSAGE.ERROR.HEADER.NO_RESOURCE_FOUND;
	      var oModalFooter = null;
	
	      if (this.props.resourceSpecification) {
	        // get resource URL
	        // TODO: Refactor this component to V02
	        sResourceURL = (0, _product.getProductResourceURL)(this.props.resourceSpecification.idProduct || this.props.resourceSpecification.id_product, this.props.resourceSpecification.name);
	
	        // set modal Title
	        sTitle = this.props.resourceSpecification.name_custom || '';
	
	        // load proper component
	        sModalContentType = this.props.modalType ? (0, _modal.getResourceType)(this.props.modalType) : (0, _modal.getResourceType)(this.props.type);
	        // sModalContentType = getResourceType(this.props.modalType);
	
	        switch (sModalContentType) {
	          case _constants.MODAL.CONTENT.APPLICATION:
	            sComponentToLoad = _react2.default.createElement(_document2.default, { URL: sResourceURL });
	            break;
	          case _constants.MODAL.CONTENT.FORM:
	            sComponentToLoad = _react2.default.createElement(_form2.default, { formToShow: this.props.formToShow, fields: this.state.formData,
	              onChangeFormField: this.onChangeFormField
	            });
	            sTitle = _constants.MODAL.MESSAGE.CONTACT.HEADER;
	            break;
	          case _constants.MODAL.CONTENT.IMAGE:
	            sComponentToLoad = _react2.default.createElement(_image2.default, { URL: sResourceURL, alt: sTitle });
	            break;
	          case _constants.MODAL.CONTENT.VIDEO:
	            sComponentToLoad = _react2.default.createElement(_video2.default, { URL: sResourceURL, videoType: this.props.modalType });
	            break;
	          default:
	            break;
	        }
	      ...
	      return _react2.default.createElement(
	        _Modal2.default,
	        { show: this.props.show, onHide: this.props.onHide, className: 'resource-modal', bsSize: 'lg', animation: true },
	        _react2.default.createElement(
	  ...
	  this.getContentType = function (props) {
	    var modalType = (0, _modal.getResourceType)(props.modalType);
	
	    if (modalType === _constants.MODAL.CONTENT.FORM) {
	      var model = new models.FormViewModel(props.formToShow);
	      var modelName = model.getModels();
	
	      _this2.setState({ modalType: modalType });
	      _this2.setFormModel(modelName);
	    }
	  };
	
	  this.onChangeFormField = function (evt) {
	    var formData = _extends({}, _this2.state.formData);
	    formData[evt.target.name] = evt.target.value;
	    formData.type = _this2.props.formToShow;
	    _this2.setState({ formData: formData });
	  };
	
	  this.sendForm = function (evt) {
	    var formData = _extends({}, _this2.state.formData);
	    // set product id to send it
	    formData[_constants.MODELS.MESSAGE.PRODUCT.PRODUCTID] = _this2.props.resourceSpecification.id_item;
	
	    _this2.setState({ formData: formData }, function () {
	      // API CALL
	      new _actions2.default(_this2.props.tenant).Message.send(_this2.state.formData).then(function (action) {
	  ...
	  this.setFormModel = function (modelName) {
	    var formData = _extends({}, _this2.state.formData);
	    ...
	    try {
	      for (var _iterator = Object.keys(modelName)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var key = _step.value;
	    ...
	    formData[_constants.MODELS.MESSAGE.PRODUCT.SEX] = _constants.MODELS.MESSAGE.PRODUCT.FEMALE;
	    _this2.setState({ formData: formData });
	  };
	
	  this.setModalFooter = function (sResourceURL, sModalContentType) {
	    var formattedMessage = _this2.context.intl.formatMessage;
	    if (sResourceURL) {
	      // if is a MEDIA VIEWER MODAL, set a DOWNLOAD button
	      if (sModalContentType !== _constants.MODAL.CONTENT.FORM) {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: sResourceURL, download: true, title: formattedMessage({ id: 'download' }), className: 'btn btn-default' },
	      ...
	      if (sModalContentType === _constants.MODAL.CONTENT.FORM) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _Button2.default,
	            { title: formattedMessage({ id: 'send' }), onClick: _this2.sendForm },
	            _react2.default.createElement(_send2.default, null),
	            _react2.default.createElement(
	              'span',
	              { title: formattedMessage({ id: 'send' }) },
	              '\xA0',
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'send' })
	            )
	          ),
	          _react2.default.createElement(
	            _Button2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Document = function (_Components) {
	  _inherits(Document, _Components);
	  ...
	  _createClass(Document, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('iframe', { src: this.props.URL, frameBorder: '0', style: { width: '100%', height: '60vh' } });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FOProductContactUs = function (_Components) {
	  _inherits(FOProductContactUs, _Components);
	
	  function FOProductContactUs() {
	    _classCallCheck(this, FOProductContactUs);
	
	    return _possibleConstructorReturn(this, (FOProductContactUs.__proto__ || Object.getPrototypeOf(FOProductContactUs)).apply(this, arguments));
	  }
	
	  _createClass(FOProductContactUs, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { type: 'hidden', name: 'c[product]', value: '' }),
	        _react2.default.createElement('input', { id: 'submitContactForm', type: 'submit', className: 'hidden' }),
	        _react2.default.createElement(
	          'div',
	          { className: 'global-row voffset-top-2' },
	          _react2.default.createElement(
	            _Row2.default,
	            null,
	            _react2.default.createElement(
	              _Col2.default,
	              { md: 8, className: 'col-md-offset-2' },
	              _react2.default.createElement(
	                'div',
	                { className: 'form-group formRadioInput' },
	                _react2.default.createElement(
	                  'label',
	                  { className: 'col-md-2' },
	                  '*Civilit\xE9'
	                ...
	                _react2.default.createElement(
	                  _Col2.default,
	                  { md: 10, className: 'formRadioOptions', onChange: this.props.onChangeFormField },
	                  _react2.default.createElement(
	                    _Col2.default,
	                    { md: 3 },
	                    _react2.default.createElement('input', { type: 'radio', name: _constants.MODELS.MESSAGE.PRODUCT.SEX, value: 'F', defaultChecked: true, required: 'required' }),
	                    '\xA0Madame'
	                  ),
	                  _react2.default.createElement(
	                    _Col2.default,
	                    { md: 3 },
	                    _react2.default.createElement('input', { type: 'radio', name: _constants.MODELS.MESSAGE.PRODUCT.SEX, value: 'M', required: 'required' }),
	                    '\xA0Monsieur'
	                  )
	                )
	              ),
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'label',
	                  { className: 'col-md-2 labelInputTxt' },
	                  '*Nom'
	                ),
	                _react2.default.createElement(
	                  _Col2.default,
	                  { md: 10 },
	                  _react2.default.createElement('input', { type: 'text', name: _constants.MODELS.MESSAGE.PRODUCT.NAME, required: 'required', className: 'form-control', onBlur: this.props.onChangeFormField })
	                )
	              ),
	              _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                  _Col2.default,
	                  { md: 10 },
	                  _react2.default.createElement('input', { type: 'text', name: _constants.MODELS.MESSAGE.PRODUCT.LASTNAME, required: 'required', className: 'form-control', onBlur: this.props.onChangeFormField })
	                )
	              ),
	              _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                  _Col2.default,
	                  { md: 10 },
	                  _react2.default.createElement('input', { type: 'email', name: _constants.MODELS.MESSAGE.PRODUCT.EMAIL, required: 'required', className: 'form-control', onBlur: this.props.onChangeFormField })
	                )
	              ),
	              _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                  _Col2.default,
	                  { md: 10 },
	                  _react2.default.createElement('input', { type: 'tel', name: _constants.MODELS.MESSAGE.PRODUCT.PHONE, required: 'required', className: 'form-control', onBlur: this.props.onChangeFormField })
	                )
	              ),
	              _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                  _Col2.default,
	                  { md: 10 },
	                  _react2.default.createElement('input', { type: 'text', name: _constants.MODELS.MESSAGE.PRODUCT.COMPANY, required: 'required', className: 'form-control', onBlur: this.props.onChangeFormField })
	                )
	              ),
	              _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                  'label',
	                  { className: 'col-md-4 labelInputTxt' },
	                  '*Je vous contacte \xE0 propos'
	                ),
	                _react2.default.createElement(
	                  _Col2.default,
	                  { md: 8 },
	                  _react2.default.createElement(
	                    'select',
	                    { name: _constants.MODELS.MESSAGE.PRODUCT.SUBJECT, required: 'required', onChange: this.props.onChangeFormField },
	                    _react2.default.createElement(
	                      'option',
	                      { value: '', disabled: true, defaultValue: true, style: { display: 'none' } },
	                      'Label'
	                    ),
	                    _react2.default.createElement(
	                      'option',
	                      { value: 'Je souhaite des renseignements' },
	                      'Je souhaite des renseignements'
	                    ),
	                    _react2.default.createElement(
	                      'option',
	                      { value: 'J\'ai un projet \xE0 court terme (- de 2 mois)' },
	                      'J\'ai un projet \xE0 court terme (- de 2 mois)'
	                    ),
	                    _react2.default.createElement(
	                      'option',
	                      { value: 'J\'ai une question technique/fonctionnelle' },
	                      'J\'ai une question technique/fonctionnelle'
	                    ),
	                    _react2.default.createElement(
	                      'option',
	                      { value: 'Je souhaite avoir un devis' },
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  _Col2.default,
	                  { md: 8 },
	                  _react2.default.createElement('textarea', { name: _constants.MODELS.MESSAGE.PRODUCT.MESSAGE, rows: '5', className: 'form-control', onBlur: this.props.onChangeFormField })
	                )
	              )
	            )
	          )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _foProductContactUs = __webpack_require__(577);
	
	var _foProductContactUs2 = _interopRequireDefault(_foProductContactUs);
	...
	var Form = function (_Components) {
	  _inherits(Form, _Components);
	  ...
	  _createClass(Form, [{
	    ...
	    value: function render() {
	      ...
	      switch (this.props.formToShow) {
	        case _constants.FORM.FO.PRODUCT.CONTACTUS:
	          oForm = _react2.default.createElement(_foProductContactUs2.default, { fields: this.props.fields, onChangeFormField: this.props.onChangeFormField });
	          break;
	      }
	      return _react2.default.createElement(
	        'form',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Image = function (_Components) {
	  _inherits(Image, _Components);
	  ...
	  _createClass(Image, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('img', { src: this.props.URL, alt: this.props.alt, className: 'modalContentMedia' });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Video = function (_Components) {
	  _inherits(Video, _Components);
	  ...
	  _createClass(Video, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'video',
	        { className: 'modalContentMedia', controls: true },
	        _react2.default.createElement('source', { src: this.props.URL, type: this.props.videoType })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.FormViewModel = undefined;
	...
	var FormViewModel = exports.FormViewModel = function () {
	  function FormViewModel(sViewComponent) {
	    _classCallCheck(this, FormViewModel);
	
	    this._viewModel = sViewComponent || 'default';
	  }
	
	  _createClass(FormViewModel, [{
	    key: 'getModels',
	    value: function getModels() {
	      switch (this._viewModel) {
	        case 'FOProductContactUs':
	          var oModel = {};
	          oModel[_constants.MODELS.MESSAGE.PRODUCT.SEX] = '';
	          oModel[_constants.MODELS.MESSAGE.PRODUCT.NAME] = '';
	          oModel[_constants.MODELS.MESSAGE.PRODUCT.LASTNAME] = '';
	          oModel[_constants.MODELS.MESSAGE.PRODUCT.EMAIL] = '';
	          oModel[_constants.MODELS.MESSAGE.PRODUCT.PHONE] = '';
	          oModel[_constants.MODELS.MESSAGE.PRODUCT.COMPANY] = '';
	          oModel[_constants.MODELS.MESSAGE.PRODUCT.SUBJECT] = '';
	          oModel[_constants.MODELS.MESSAGE.PRODUCT.MESSAGE] = '';
	          return oModel;
	        case 'default':
	          return '';
	        default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HorizontalResourceList = (_temp2 = _class = function (_Components) {
	  _inherits(HorizontalResourceList, _Components);
	
	  function HorizontalResourceList() {
	    var _ref;
	
	    var _temp, _this, _ret;
	
	    _classCallCheck(this, HorizontalResourceList);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HorizontalResourceList.__proto__ || Object.getPrototypeOf(HorizontalResourceList)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (resource) {
	      return function (evt) {
	        evt.preventDefault();
	        _this.props.onClick(resource)();
	      };
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  _createClass(HorizontalResourceList, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      if (this.props.resources.length === 0) {
	        resources.push(_react2.default.createElement(
	          _reactBootstrap.Col,
	          null,
	          _react2.default.createElement(
	            'p',
	        ...
	        resources = this.props.resources.map(function (resource, index) {
	          var placeholderURL = _this2.props.placeholder || '/public/uploads/products/' + resource.idProduct + '/' + resource.name;
	          return _react2.default.createElement(
	            _reactBootstrap.Col,
	            { key: index, xs: 6, md: 4, lg: 3 },
	            _react2.default.createElement(
	              'div',
	              { className: 'resource hentry h-entry' },
	              _react2.default.createElement(
	                _reactRouter.Link,
	                { to: '#', className: 'url u-url', rel: 'bookmark', onClick: _this2.onClick(resource) },
	                _react2.default.createElement(
	                  'div',
	                  { className: 'thumb' },
	                  _react2.default.createElement('img', { className: 'photo u-photo', src: placeholderURL, alt: resource.name_custom })
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'info' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalBase = __webpack_require__(543);
	
	var _modalBase2 = _interopRequireDefault(_modalBase);
	
	var _features = __webpack_require__(415);
	
	var _horizontalResourceList = __webpack_require__(700);
	
	var _horizontalResourceList2 = _interopRequireDefault(_horizontalResourceList);
	...
	var Resources = function (_Components) {
	  _inherits(Resources, _Components);
	  ...
	  function Resources(props) {
	    ...
	    _this.openModal = function (resource) {
	      return function () {
	        _this.setState({
	  ...
	  _createClass(Resources, [{
	    key: 'groupResources',
	    value: function groupResources(resources) {
	      var oResources = { Videos: [], Images: [], Documents: [], Others: [] };
	      return resources.reduce(function (previous, current) {
	        if (current.type.startsWith(_constants.PRODUCT.RESOURCE.APPLICATION)) {
	          previous.Documents.push(current);
	          return previous;
	        }
	        if (current.type.startsWith(_constants.PRODUCT.RESOURCE.IMAGE)) {
	          previous.Images.push(current);
	          return previous;
	        }
	        if (current.type.startsWith(_constants.PRODUCT.RESOURCE.VIDEO)) {
	    ...
	    value: function render() {
	      ...
	      if (!product.availableFeatures.find(function (productFeatures) {
	        return _features.PRODUCT_RESOURCES.id === productFeatures.idFeature;
	      })) {
	        return _react2.default.createElement(
	          'div',
	          null,
	      ...
	      var _map = [_horizontalResourceList2.default].map(function (Component) {
	        return Component.get(tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          HorizontalResourceList = _map2[0];
	
	      var resources = this.groupResources(product.resources);
	      var sections = Object.keys(resources).map(function (sectionTitle) {
	        var placeholder = undefined;
	        if (sectionTitle !== 'Images') {
	          placeholder = '/public/images/placeholders/' + sectionTitle + '.png';
	        }
	        return _react2.default.createElement(HorizontalResourceList, { key: sectionTitle, title: sectionTitle, onClick: _this2.openModal,
	          resources: resources[sectionTitle], placeholder: placeholder });
	      });
	
	      return _react2.default.createElement(
	        'div',
	        { className: 'mp-tab mp-tab-resources' },
	        _react2.default.createElement(
	          'div',
	          { className: 'mp-blocks resources' },
	          sections
	        ),
	        _react2.default.createElement(_modalBase2.default, { show: this.state.showModal, onHide: this.closeModal,
