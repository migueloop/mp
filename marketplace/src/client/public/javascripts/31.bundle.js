...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homeCarousel = __webpack_require__(1216);
	
	var _homeCarousel2 = _interopRequireDefault(_homeCarousel);
	
	var _homeDomains = __webpack_require__(1218);
	
	var _homeDomains2 = _interopRequireDefault(_homeDomains);
	
	var _homeProducts = __webpack_require__(1219);
	
	var _homeProducts2 = _interopRequireDefault(_homeProducts);
	...
	var Home = (_temp = _class = function (_Components) {
	  _inherits(Home, _Components);
	  ...
	  _createClass(Home, [{
	    ...
	    value: function componentDidMount() {
	      Home.getActions(this.props.tenant, this.props.params, this.props.location.query).map(this.props.dispatch);
	      // this.guid = this.addListener([ACTION.CORNER.EDIT]);
	    }
	  }, {
	    key: 'componentWillUnmount',
	    value: function componentWillUnmount() {
	      // this.removeListener(this.guid);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      // const [Carousel, Corners, Products] =
	      var _map = [_homeCarousel2.default, _homeDomains2.default, _homeProducts2.default].map(function (cmpt) {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _reactBootstrap.Col,
	              { sm: 8, md: 9 },
	              _react2.default.createElement(Domains, { domains: this.props.domains.toJS(), title: _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'com_corners' }) })
	            ),
	            _react2.default.createElement(
	              _reactBootstrap.Col,
	              { sm: 4, md: 3 },
	              _react2.default.createElement(Products, { products: this.props.products.toJS(),
	    ...
	    value: function getActions(tenant) {
	      ...
	      return [actions.FrontOffice.Products.fetchLatest(5), actions.FrontOffice.HomeCarousel.fetch()];
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var connector = (0, _reactRedux.connect)(function (state) {
	  return {
	    tenant: state.get('v02').get('common').get('tenant').get('name'),
	    carousel: state.get('v02').get('frontOffice').get('homeCarousel')
	  };
	});
	
	var HomeCarousel = function (_Components) {
	  _inherits(HomeCarousel, _Components);
	  ...
	  _createClass(HomeCarousel, [{
	    ...
	    value: function render() {
	      ...
	      var slides = this.props.carousel.toJS().map(function (oSlide, index) {
	        var detailLink = oSlide.link ? _react2.default.createElement(
	          _reactRouter.Link,
	          { to: oSlide.link,
	        ...
	        return _react2.default.createElement(
	          ...
	          { key: index,
	            style: { backgroundImage: 'url(/public/uploads/' + _this2.props.tenant + '/carousel/' + oSlide.mainPicture + ')' },
	      ...
	      var controls = slides.length <= 1 ? 'hide-controls' : '';
	
	      return slides.length >= 1 && _react2.default.createElement(
	        'div',
	        { className: 'mp-carousel ' + controls },
	        _react2.default.createElement(
	...
	var _components = {
	  default: connector(HomeCarousel)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HomeCornersMsp = function (_Components) {
	  _inherits(HomeCornersMsp, _Components);
	
	  function HomeCornersMsp() {
	    _classCallCheck(this, HomeCornersMsp);
	
	    return _possibleConstructorReturn(this, (HomeCornersMsp.__proto__ || Object.getPrototypeOf(HomeCornersMsp)).apply(this, arguments));
	  }
	
	  _createClass(HomeCornersMsp, [{
	    key: 'render',
	    value: function render() {
	      /* TODO: need corner.css or corner.color... */
	      var grid = this.props.domains.map(function (domain) {
	        return _react2.default.createElement(
	          _reactBootstrap.Col,
	          { sm: 6, md: 4, lg: 3, key: domain.id },
	          _react2.default.createElement(
	            'div',
	            { className: 'corner' + (domain.name ? ' corner-' + domain.name.trim().toLowerCase() : '') },
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: '/domain/' + domain.alias },
	              _react2.default.createElement(
	                'div',
	                { className: 'thumb' },
	                _react2.default.createElement('img', { src: domain.logoUrl, alt: '' })
	              ),
	              _react2.default.createElement(
	                'div',
	                { className: 'info ' + domain.name },
	                _react2.default.createElement(
	                  'h4',
	                  { className: 'title' },
	                  domain.name
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'div',
	                  { className: 'thumb' },
	                  _react2.default.createElement('img', { src: '/public/images/corner-all.png', alt: '' })
	                ),
	                _react2.default.createElement(
	                  'div',
	                  { className: 'info' },
	                  _react2.default.createElement(
	                    'h4',
	                    { className: 'title' },
	                    _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'com_catalogue' })
	                  )
	                )
	              )
	            )
	  ...
	  return HomeCornersMsp;
	}(_baseComponent2.default);
	
	exports.default = connector(HomeCornersMsp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homeDomainsMississippi = __webpack_require__(1217);
	
	var _homeDomainsMississippi2 = _interopRequireDefault(_homeDomainsMississippi);
	...
	var HomeDomains = function (_Components) {
	  _inherits(HomeDomains, _Components);
	
	  function HomeDomains() {
	    _classCallCheck(this, HomeDomains);
	
	    return _possibleConstructorReturn(this, (HomeDomains.__proto__ || Object.getPrototypeOf(HomeDomains)).apply(this, arguments));
	  }
	
	  _createClass(HomeDomains, [{
	    key: 'render',
	    value: function render() {
	      /* TODO: need corner.css or corner.color... */
	      var grid = this.props.domains.map(function (domain) {
	        ...
	        return _react2.default.createElement(
	          _reactBootstrap.Col,
	          { sm: 6, md: 6, lg: 4, key: domain.id },
	          _react2.default.createElement(
	            'div',
	            { className: 'corner ' + (domain.name ? ' corner-' + domain.name.toLowerCase() : '') },
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: '/domain/' + domain.alias },
	              _react2.default.createElement('div', { className: 'thumb', style: { backgroundImage: 'url(' + domain.logoUrl + ')' } }),
	              _react2.default.createElement(
	                'div',
	                { className: 'info ' + (!domain.name ? 'hidden' : '') },
	                _react2.default.createElement(
	                  'h4',
	                  { className: 'title' },
	                  domain.name
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'h4',
	                    { className: 'title' },
	                    _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'corner_view_all' })
	                  )
	                )
	              )
	            )
	...
	var _components = {
	  ...
	  mississippi: _homeDomainsMississippi2.default
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HomeProducts = function (_Components) {
	  _inherits(HomeProducts, _Components);
	
	  function HomeProducts() {
	    _classCallCheck(this, HomeProducts);
	
	    return _possibleConstructorReturn(this, (HomeProducts.__proto__ || Object.getPrototypeOf(HomeProducts)).apply(this, arguments));
	  }
	
	  _createClass(HomeProducts, [{
	    key: 'render',
	    value: function render() {
	      var column = this.props.products.map(function (product) {
	        return _react2.default.createElement(_product2.default, { key: product.id, product: product, link: product.url });
	      });
	      return _react2.default.createElement(
	        'div',
	        { className: 'mp-products latest' },
	        _react2.default.createElement(
	          'h2',
	          null,
	          this.props.title
