...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getNotificationSubjectName = exports.getNotifcationUrl = undefined;
	
	var _constants = __webpack_require__(38);
	
	var getNotifcationUrl = exports.getNotifcationUrl = function getNotifcationUrl(notification) {
	  switch (notification.type) {
	    case _constants.NOTIFICATION.TYPE.PUBLICATION_REQUEST_PRODUCT:
	      return '/admin/content/products?productId=' + notification.id_subject;
	    case _constants.NOTIFICATION.TYPE.PUBLICATION_REQUEST_BUNDLE:
	      return '/admin/content/bundles?bundleId=' + notification.id_subject;
	    case _constants.NOTIFICATION.TYPE.PUBLICATION_REQUEST_ASSIGNMENT:
	      return '/admin/assignments/draft?assignmentId=' + notification.id_subject;
	    case _constants.NOTIFICATION.TYPE.TIMELINE_ACTION_ASSIGNMENT_ORDER:
	...
	var getSubjectNameSafe = function getSubjectNameSafe(list, notification, property) {
	  return list && list.length > 0 && notification.id_subject && list.find(function (x) {
	    return x.id == notification.id_subject;
	  }) && list.find(function (x) {
	    return x.id == notification.id_subject;
	  })[property];
	};
	
	var getNotificationSubjectName = exports.getNotificationSubjectName = function getNotificationSubjectName(data) {
	  var products = data.products,
	      bundles = data.bundles,
	      assignments = data.assignments,
	      assignmentOrders = data.assignmentOrders,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FaBell = (function (_React$Component) {
	    ...
	    FaBell.prototype.render = function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FaThLarge = (function (_React$Component) {
	    ...
	    FaThLarge.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdCardGiftcard = (function (_React$Component) {
	    ...
	    MdCardGiftcard.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdLocalOffer = (function (_React$Component) {
	    ...
	    MdLocalOffer.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MdNewReleases = (function (_React$Component) {
	    ...
	    MdNewReleases.prototype.render = function render() {
	        return React.createElement(
	            IconBase,
	            _extends({ viewBox: '0 0 40 40' }, this.props),
	            React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserNotifications = function (_Components) {
	  _inherits(UserNotifications, _Components);
	  ...
	  function UserNotifications() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = UserNotifications.__proto__ || Object.getPrototypeOf(UserNotifications)).call.apply(_ref, [this].concat(args))), _this), _this.onClickNotification = function (notification) {
	      return function () {
	        var promise = void 0;
	        if (notification.clicked_at) {
	          promise = Promise.resolve(notification);
	        } else {
	          promise = new _actions2.default(_this.props.tenant).UserNotifications.click(notification.id).then(function (action) {
	            return _this.props.dispatch(action);
	          }).then(function (action) {
	            return Promise.resolve(action.payload);
	          });
	        }
	        return promise.then(function (notificationData) {
	          return _this.navigate((0, _notification.getNotifcationUrl)(notificationData));
	        });
	      };
	    }, _this.getIconType = function (key) {
	      switch (key) {
	        case 'notification_publication_request_product':
	          return _cardGiftcard2.default;
	        case 'notification_publication_request_bundle':
	          return _thLarge2.default;
	        case 'notification_publication_request_assignment':
	          return _newReleases2.default;
	        case 'notification_timeline_action_assignment_order':
	          return _localOffer2.default;
	        default:
	          return _bell2.default;
	      }
	  ...
	  _createClass(UserNotifications, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_contentHeader2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          ContentHeader = _map2[0];
	
	      var notifications = this.props.notifications.toJS();
	      var notificationsJSX = notifications.map(function (notification) {
	        var subjectNameData = {
	          products: _this2.props.products.toJS() || [],
	          bundles: _this2.props.bundles.toJS() || [],
	          assignments: _this2.props.assignments.toJS() || [],
	          assignmentOrders: _this2.props.assignmentOrders || [],
	          notification: notification
	        };
	        var name = (0, _notification.getNotificationSubjectName)(subjectNameData);
	        var id = notification.id;
	        var type = notification.type;
	        var subjectId = notification.id_subject;
	        var createdAt = notification.created_at;
	        var viewedAt = notification.viewed_at;
	        var clickedAt = notification.clicked_at;
	        var className = 'user-notification ' + (clickedAt ? 'clicked' : '');
	        var Icon = _this2.getIconType(type);
	
	        var getOrderId = function getOrderId(refId) {
	          var assignmentOrders = _this2.props.assignmentOrders.toJS();
	          var assignmentMatch = assignmentOrders.find(function (a) {
	            return parseInt(a.id, 10) === refId;
	          });
	        ...
	        return _react2.default.createElement(
	          'div',
	          { onClick: _this2.onClickNotification(notification), className: className },
	          _react2.default.createElement(
	            _Row2.default,
	            null,
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(_reactIntl.FormattedRelative, { value: createdAt })
	              ),
	              _react2.default.createElement(
	                'span',
	                { className: 'notification-date' },
	                _react2.default.createElement(_reactIntl.FormattedDate, { value: (0, _moment2.default)(createdAt).format('YYYY-MM-DD'), day: 'numeric', month: 'numeric', year: 'numeric' }),
	                '\xA0-\xA0',
	                (0, _moment2.default)(createdAt).format('hh:mm')
	              )
	            ),
	            _react2.default.createElement(
	              _Col2.default,
	              { xs: 1 },
	              _react2.default.createElement(Icon, { className: 'ico' })
	            ),
	            _react2.default.createElement(
	              _Col2.default,
	              { xs: 5 },
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'container' },
	        _react2.default.createElement(ContentHeader, { contentTitle: 'notification_history', className: 'padding-bottom' }),
	        _react2.default.createElement(
	          _Row2.default,
	...
	var _components = { default: (0, _reactRedux.connect)(stateToProps)(UserNotifications) };
