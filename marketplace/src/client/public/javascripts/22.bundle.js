	...
	var Carousel = function (_Components) {
	  ...
	  _createClass(Carousel, [{
	    ...
	    value: function render() {
	      var multi = this.props.children.length > 1;
	      var props = {
	        arrows: multi,
	        dots: multi,
	        // dotsClass: '',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _carousel = __webpack_require__(623);
	...
	var Summary = function (_Components) {
	  ...
	  _createClass(Summary, [{
	    ...
	    value: function render() {
	      ...
	      if (!product.availableFeatures.find(function (productFeatures) {
	        return _features.PRODUCT_SUMMARY.id === productFeatures.idFeature;
	      })) {
	        return _react2.default.createElement(
	          'div',
	          null,
	      ...
	      var productDescription = { __html: product.description };
	      // TODO: factorize with Components/Shared/KeywordList...
	      var productKeywords = product.keywords.map(function (keyword) {
	      ...
	      var aHomeImages = product.resources.filter(function (p) {
	        return !!p.homeOrder;
	      });
	      aHomeImages.sort(function (a, b) {
	        return a.homeOrder - b.homeOrder;
	      });
	      var aGalleryImages = aHomeImages.map(function (oImage, index) {
	        var galleryImage = {
	      ...
	      var oSlides = aGalleryImages.map(function (resource, index) {
	        return _react2.default.createElement(
	          _CarouselItem2.default,
	          { key: index },
	          _react2.default.createElement('img', { src: resource.original })
	        );
	      });
	
	      console.log("SLIDES2-->", aGalleryImages);
	
	      var _map = [_carousel2.default].map(function (cmpt) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _reactBootstrap.Col,
	            { sm: 12, md: 5, xs: 12 },
	            oSlides.length > 0 && _react2.default.createElement(
	              Carousel,
	              {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('div', { className: 'description e-description', dangerouslySetInnerHTML: productDescription }),
	            _react2.default.createElement(
	              'p',
	              { className: 'more' },
	              !!product.availableFeatures.find(function (productFeatures) {
	                return _features.PRODUCT_FEATURES.id === productFeatures.idFeature;
	              }) && _react2.default.createElement(
	                _reactRouter.Link,
	                { to: '/product/' + product.alias + '/features' },
	                _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'product_read_more' })
	              )
	            )
	          )
	        )
