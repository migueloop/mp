...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactBootstrapSwitch = __webpack_require__(1450);
	...
	var Switch = (_temp = _class = function (_Components) {
	  _inherits(Switch, _Components);
	  ...
	  _createClass(Switch, [{
	    ...
	    value: function render() {
	      ...
	      var props = _extends({ onText: formattedMessage({ id: 'on' }), offText: formattedMessage({ id: 'off' }) }, this.props);
	      return _react2.default.createElement(
	        'div',
	        { style: { marginLeft: '35%' } },
	        _react2.default.createElement(_reactBootstrapSwitch2.default, _extends({}, props, { state: this.props.isChecked, animate: true, onChange: function onChange(element, state) {
	            return _this2.props.onChange(state);
	          } }))
	      );
	    }
	  }]);
	  ...
	  isChecked: _react2.default.PropTypes.boolean
	}, _temp);
	
	
	var _components = { default: Switch };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _switch = __webpack_require__(1011);
	...
	var Settings = (_temp = _class = function (_Components) {
	  _inherits(Settings, _Components);
	  ...
	  function Settings(props) {
	    ...
	    _this.getRows = function (currentlyEnabledFeatures) {
	      return _features.PRODUCT_AVAILABLE_FEATURES.map(function (feature) {
	        var isEnabled = currentlyEnabledFeatures.isIntersected(feature.id);
	        var MyRow = _react2.default.createElement(
	          _Row2.default,
	          { className: 'rows-alt' },
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 6 },
	            _this.format({ id: feature.id })
	          ),
	          _react2.default.createElement(
	            _Col2.default,
	            { xs: 6, className: 'text-right' },
	            _this.transform.available(isEnabled, feature)
	          )
	        );
	        return MyRow;
	      });
	    ...
	    _this.onChangeSwitchButton = function (rowData) {
	      return _underscore2.default.debounce(function (state) {
	        return _this.props.onChangeFeatureAvailability(rowData.id, state);
	      }, 300);
	    };
	
	    _this.transform = {
	      available: function available(isChecked, rowData) {
	        // If a feature is forced active then we disable it.
	        var disabled = rowData.forceActive || false;
	        var SwitchBtn = _this.switchButton;
	        var offText = _this.format({ id: 'no' });
	        var onText = _this.format({ id: 'yes' });
	        var onChange = _this.onChangeSwitchButton(rowData);
	        return _react2.default.createElement(SwitchBtn, { disabled: disabled, onText: onText, offText: offText, isChecked: isChecked, onChange: onChange });
	      }
	    };
	
	    _this.switchButton = _switch2.default.get(_this.props.tenant);
	    return _this;
	  }
	  ...
	  _createClass(Settings, [{
	    ...
	    value: function componentDidMount() {
	      Promise.all(Settings.getActions(this.props.tenant, this.props.params, this.props.location.query, this.props.user).map(this.props.dispatch));
	    }
	  }, {
	    key: 'componentWillMount',
	    value: function componentWillMount() {
	    ...
	    key: 'render',
	    value: function render() {
	      var features = this.props.product.availableFeatures || [];
	      var rows = this.getRows(features);
	      return _react2.default.createElement(
	        'div',
	        { className: 'mp-tab mp-tab-summary' },
	        _react2.default.createElement(
	          'div',
	          null,
	          rows
	...
	var _components = { default: Settings };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../css-loader/index.js!./react-bootstrap-switch.min.css", function() {
				var newContent = require("!!./../../../../css-loader/index.js!./react-bootstrap-switch.min.css");
