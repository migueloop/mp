...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserVoice = function (_Components) {
	  _inherits(UserVoice, _Components);
	
	  function UserVoice() {
	    _classCallCheck(this, UserVoice);
	
	    return _possibleConstructorReturn(this, (UserVoice.__proto__ || Object.getPrototypeOf(UserVoice)).apply(this, arguments));
	  }
	
	  _createClass(UserVoice, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('iframe', { src: _constants.USERVOICE.URL.INTERCOM_BO, className: 'billing-system-offers-bo', security: 'restricted' });
	    }
	  }]);
	...
	var _components = { default: UserVoice };
