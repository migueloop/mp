...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentHeader = (_temp = _class = function (_Components) {
	  _inherits(ContentHeader, _Components);
	  ...
	  contentActions: _react2.default.PropTypes.object.isRequired,
	  contentTitle: _react2.default.PropTypes.string.isRequired
	}, _temp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// const connector
	var Action = (_temp = _class = function (_Components) {
	  ...
	  _createClass(Action, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        _Button2.default,
	        { disabled: this.props.disabled, onClick: this.props.onClick, className: this.props.className },
	        _react2.default.createElement(_Glyphicon2.default, { glyph: this.props.icon, className: 'ico ico-left' }),
	        this.props.text
	      );
	    }
	  }]);
	...
	}, _class.defaultProps = { width: '100%' }, _temp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _button = __webpack_require__(460);
	...
	var _action = __webpack_require__(453);
	...
	var TableActions = (_temp2 = _class = function (_Components) {
	  _inherits(TableActions, _Components);
	  ...
	  function TableActions() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TableActions.__proto__ || Object.getPrototypeOf(TableActions)).call.apply(_ref, [this].concat(args))), _this), _this.getButtonOptions = function (type) {
	      switch (type) {
	
	        case 'view':
	          return { icon: 'eye-open', text: _this.format({ id: 'visualize' }), className: 'btn-view btn-ico-left' };
	
	        case 'edit':
	          return { icon: 'pencil', text: _this.format({ id: 'modify' }), className: 'btn-edit btn-ico-left' };
	
	        case 'validate':
	          return { icon: 'ok', text: _this.format({ id: 'validate' }), className: 'btn-validate btn-ico-left' };
	
	        case 'request-publication':
	          return { icon: 'eye-open', text: _this.format({ id: 'demand_publication' }), className: 'btn-request-publication btn-ico-left' };
	
	        case 'publish':
	          return { icon: 'cloud-upload', text: _this.format({ id: 'publish' }), className: 'btn-publish btn-ico-left' };
	
	        case 'unpublish':
	          return { icon: 'cloud-download', text: _this.format({ id: 'unpublish' }), className: 'btn-unpublish btn-ico-left' };
	
	        case 'remove':
	          return { icon: 'remove', text: _this.format({ id: 'remove' }), className: 'btn-remove btn-ico-left' };
	
	        case 'withdraw':
	          return { icon: 'remove', text: _this.format({ id: 'withdraw' }), className: 'btn-withdraw btn-ico-left' };
	  ...
	  _createClass(TableActions, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_action2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          ActionButton = _map2[0];
	
	      var buttons = _react2.default.Children.toArray(this.props.children).reduce(function (previous, current) {
	      ...
	      var primary = buttons.shift();
	      var buttonsUI = buttons.map(function (button, index) {
	        var style = button.style,
	            type = button.type,
	            others = _objectWithoutProperties(button, ['style', 'type']);
	
	        var buttonOptions = _this2.getButtonOptions(type);
	        return _react2.default.createElement(
	          'li',
	          { key: 'button-' + index },
	          _react2.default.createElement(ActionButton, _extends({}, buttonOptions, { style: style }, others))
	        );
	      });
	      var primaryButtonOptions = this.getButtonOptions(primary.type);
	      return _react2.default.createElement(
	        'div',
	        { className: 'table-actions-container' },
	        _react2.default.createElement(ActionButton, _extends({}, primaryButtonOptions, primary)),
	        _react2.default.createElement(
	          _Dropdown2.default,
	          { id: 'dropdown-' + Math.random(), pullRight: true, style: { display: buttonsUI.length > 0 ? '' : 'none' } },
	          _react2.default.createElement(
	            _Dropdown2.default.Toggle,
	            { pullRight: true, noCaret: true },
	            _react2.default.createElement(_Glyphicon2.default, { glyph: 'option-horizontal' })
	          ),
	          _react2.default.createElement(
	            _Dropdown2.default.Menu,
	            null,
	  ...
	  return TableActions;
	}(_baseComponent2.default), _class.propTypes = {}, _temp2);
	...
	var _components = {
	  default: (0, _connect2.default)(stateToProps)(TableActions)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tableActions = __webpack_require__(461);
	...
	var _contentHeader = __webpack_require__(435);
	...
	var Thematics = (_dec = (0, _reactRedux.connect)(function (state) {
	  return {
	    tenant: state.get('v02').get('common').get('tenant').get('name'),
	  ...
	  _inherits(Thematics, _Components);
	
	  function Thematics(props) {
	    _classCallCheck(this, Thematics);
	
	    var _this = _possibleConstructorReturn(this, (Thematics.__proto__ || Object.getPrototypeOf(Thematics)).call(this, props));
	
	    _this.hideDeleteConfirmation = function () {
	      return _this.setState({ showDeleteConfirmation: false, showDeleteCornerWithProductsConfirmation: false });
	    };
	
	    _this.showDeleteConfirmation = function (corner) {
	      return function () {
	        _this._corner = corner;
	        console.log('corner', corner);
	        if (corner.products.length > 0) {
	          return _this.setState({ showDeleteCornerWithProductsConfirmation: true });
	        }
	        _this.setState({ showDeleteConfirmation: true });
	      };
	    };
	
	    _this.createCorner = function () {
	      _this.actions.Corners.Create({ name: 'My new corner' }).then(function (action) {
	        _this.props.dispatch(action);
	        _this.navigate('/admin/corners/edit/' + action.corner.id);
	      }).catch(function () {
	        return _this.props.notification.add({ message: _this.format({ id: 'error_creating_corner' }), level: 'error' });
	      });
	    };
	
	    _this.deleteCorner = function () {
	      var id = _this._corner.id;
	      delete _this._corner;
	      _this.hideDeleteConfirmation();
	      _this.actions.Corners.Delete(id).then(function (action) {
	        return _this.props.dispatch(action);
	      }).catch(function () {
	        return _this.props.notification.add({ message: _this.format({ id: 'error_deleting_corner' }), level: 'error' });
	      });
	    };
	
	    _this.transform = {
	      keywords: function keywords(_keywords) {
	        return _this.transform.crop(_keywords.map(function (k) {
	          return k.name;
	        }).join(', '));
	      },
	      lookUser: function lookUser(id, rowData) {
	        return rowData.email || _this.props.users.find(function (u) {
	          return u.id === id;
	        }) ? _this.props.users.find(function (u) {
	          return u.id === id;
	        }).email : '';
	      },
	      showDate: function showDate(datetime) {
	        return datetime ? new Date(datetime).toString() : 'N/A';
	      },
	      crop: function crop(text) {
	        return text.length > 60 ? text.substr(0, 57) + '...' : text;
	      },
	      actionButtons: function actionButtons(alias, rowData) {
	        var _map = [_tableActions2.default].map(function (cmpt) {
	          return cmpt.get(_this.props.tenant);
	        }),
	            _map2 = _slicedToArray(_map, 1),
	            TableActions = _map2[0];
	
	        var buttons = [];
	        buttons.push(_react2.default.createElement(TableActions.Button, { onClick: function onClick() {
	            location.href = '/domain/' + alias;
	          }, type: 'view' }));
	        if (_underscore2.default.contains(_this.props.user.permissions, _constants.PERMISSIONS.EDIT_CORNER.id)) {
	          buttons.push(_react2.default.createElement(TableActions.Button, { onClick: _this.link('/admin/corners/edit/' + rowData.id), type: 'edit' }));
	        }
	        if (_underscore2.default.contains(_this.props.user.permissions, _constants.PERMISSIONS.DELETE_CORNER.id)) {
	          buttons.push(_react2.default.createElement(TableActions.Button, { onClick: _this.showDeleteConfirmation(rowData), type: 'remove' }));
	        }
	        return _react2.default.createElement(
	          TableActions,
	          null,
	    ...
	    _this.actions = new _actions2.default(_this.props.tenant);
	    return _this;
	  }
	
	  _createClass(Thematics, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	
	      var showDeleteConfirmation = this.state.showDeleteConfirmation;
	      var showDeleteCornerWithProductsConfirmation = this.state.showDeleteCornerWithProductsConfirmation;
	      console.log('showDeleteConfirmation', showDeleteConfirmation);
	
	      var _map3 = [_confirmationPopup2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map4 = _slicedToArray(_map3, 1),
	          ConfirmationPopup = _map4[0];
	
	      var _map5 = [_contentHeader2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map6 = _slicedToArray(_map5, 1),
	          ContentHeader = _map6[0];
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ContentHeader,
	          { contentTitle: 'corners' },
	          _react2.default.createElement(
	            _Button2.default,
	            { onClick: this.createCorner, className: 'btn-add' },
	            '+ ',
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'create_corner' })
	          )
	        ),
	        _react2.default.createElement(
	          _reactDatatableBootstrap.DataTable,
	          { data: this.props.corners, dtStyle: 'dark' },
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'name', title: this.format({ id: 'name' }), sortable: true, md: 2, searchable: true }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'description', title: this.format({ id: 'description' }), md: 2, searchable: true, transform: this.transform.crop }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'keywords', title: this.format({ id: 'keywords' }), md: 3, transform: this.transform.keywords }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'created_by', title: this.format({ id: 'creator' }), md: 2, transform: this.transform.lookUser }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'last_update', title: this.format({ id: 'last_updated_at' }), md: 2, transform: this.transform.showDate }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'alias', title: this.format({ id: 'actions' }), xs: 1, transform: this.transform.actionButtons }),
	          _react2.default.createElement(_reactDatatableBootstrap.Pagination, { maxButtons: 3, itemPerPage: 10, ellipsis: false })
	        ),
	        _react2.default.createElement(
	          ConfirmationPopup,
	          { show: showDeleteConfirmation, onHide: this.hideDeleteConfirmation, onAction: this.deleteCorner, actionStyle: 'danger', action: 'Delete', title: this.format({ id: 'confirmation' }) },
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'confirm_delete_corner' })
	          )
	        ),
	        _react2.default.createElement(
	          ConfirmationPopup,
	          { show: showDeleteCornerWithProductsConfirmation, onHide: this.hideDeleteConfirmation, onAction: this.deleteCorner, actionStyle: 'danger', action: 'Delete', title: this.format({ id: 'confirmation' }) },
	          _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'confirm_delete_corner_with_products' })
	          )
	        )
	      );
	    }
	...
	var _components = { default: Thematics };
