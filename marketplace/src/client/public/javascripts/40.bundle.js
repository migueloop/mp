	...
	var Assignment = (_temp = _class = function (_Component) {
	  ...
	  _createClass(Assignment, [{
	    ...
	    value: function render() {
	      ...
	      var currentAssignmentOptionsForm = this.state.assignmentOptionsForms[0];
	      var currentAssignmentOptionsFormId = currentAssignmentOptionsForm ? currentAssignmentOptionsForm.id : null;
	      var AssignmentOptionsForm = (0, _getForm2.default)(this.props.tenant, currentAssignmentOptionsFormId);
	      var oChildrenProps = {
	        random: Math.random(),
	      ...
	      return _react2.default.createElement(
	        ...
	        !!currentAssignmentOptionsForm && _react2.default.createElement(
	          _Modal2.default,
	          ...
	          _react2.default.createElement(
	            ...
	            ' - ',
	            currentAssignmentOptionsForm.productName
	          ),
	          _react2.default.createElement(
	            _Modal2.default.Body,
	            null,
	            _react2.default.createElement(
	              'div',
	              { className: 'centered' },
	              _react2.default.createElement(AssignmentOptionsForm, { onSubmit: this.onSubmitAssignmentOptionsForm })
	            )
	          )
	        )
	      );
	  ...
	  this.getAssignmentOptionsForms = function () {
	    var bundleId = _this3.state.assignment.items[0].id_bundle;
	    var productId = _this3.state.assignment.items[0].id_product;
	    if (!bundleId) {
	      var product = _this3.props.products.toJS().find(function (product) {
	    ...
	    var bundle = _this3.props.bundles.toJS().find(function (bundle) {
	      return bundle.id === bundleId;
	    });
	    var bundleComponentIds = bundle.components.map(function (component) {
	      return component.id;
	    });
	    var products = _this3.props.products.toJS().filter(function (product) {
	      return bundleComponentIds.indexOf(product.id) !== -1;
	    });
	    var productAssignmentOrderFormIds = products.map(function (product) {
	      return {
	        id: product.id_assignment_option_form,
	    ...
	    return productAssignmentOrderFormIds.filter(function (item) {
	      return item.id !== null;
	    });
	  };
	  ...
	  this.onSubmitForm = function (e) {
	    ...
	    var assignment = _extends({}, _this3.state.assignment, { assignmentOrderOptions: _this3.state.assignmentOptions });
	    return _this3.createAssignment(assignment);
	  };
	
	  this.onSubmitAssignmentOptionsForm = function (e) {
	    e.preventDefault();
	    var assignmentOptionsForms = _this3.state.assignmentOptionsForms.concat([]);
	    var currentAssignmentOptionData = assignmentOptionsForms.shift();
	    var assignmentOrderOptions = (0, _formSerialize2.default)(e.target);
	    var dataToAdd = { productId: currentAssignmentOptionData.productId, options: assignmentOrderOptions };
	    var assignmentOptions = _this3.state.assignmentOptions.concat([dataToAdd]);
	    _this3.setState({ assignmentOptions: assignmentOptions, assignmentOptionsForms: assignmentOptionsForms }, function () {
	      if (assignmentOptionsForms.length === 0) {
	        return _this3.onSubmitForm(e);
	      }
	      _this3.openAssignmentModal();
	    });
	  };
	  ...
	  this.onClickAssignButton = function (e) {
	    if (!_this3.isAssignmentValid()) {
	      return;
	    }
	    if (_this3.state.isEdited) {
	      return _this3._update();
	    }
	    var assignmentOptionsForms = _this3.getAssignmentOptionsForms();
	    var canAddOptions = assignmentOptionsForms.length > 0;
	    if (canAddOptions) {
	      return _this3.setState({ assignmentOptionsForms: assignmentOptionsForms }, function () {
