...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditorProfiles = (_dec = (0, _reactRedux.connect)(function (state) {
	  return {
	    tenant: state.get('v02').get('common').get('tenant').get('name'),
	    users: state.get('backoffice').get('users').toJS()
	  };
	}), _dec(_class = (_temp2 = _class2 = function (_Components) {
	  _inherits(EditorProfiles, _Components);
	
	  function EditorProfiles() {
	    var _ref;
	
	    var _temp, _this, _ret;
	
	    _classCallCheck(this, EditorProfiles);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EditorProfiles.__proto__ || Object.getPrototypeOf(EditorProfiles)).call.apply(_ref, [this].concat(args))), _this), _this.transform = {
	      lookUser: function lookUser(id, rowData) {
	        return id ? rowData.email || _this.props.users.find(function (u) {
	          return u.id === id;
	        }).email : 'N/A';
	      },
	      ...
	      crop: function crop(text) {
	        return text && text.length > 60 ? text.substr(0, 57) + '...' : text;
	      },
	      actionButtons: function actionButtons(data, rowData) {
	        ...
	        return _react2.default.createElement(
	          TableActions,
	          null,
	          _react2.default.createElement(TableActions.Button, { onClick: _this.link('/admin/corners/edit/editor/' + rowData.id_user), type: 'edit' })
	        );
	      }
	    }, _temp), _possibleConstructorReturn(_this, _ret);
	  }
	
	  _createClass(EditorProfiles, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(ContentHeader, { contentTitle: 'editors_domains' }),
	        _react2.default.createElement(
	          _reactDatatableBootstrap.DataTable,
	          { data: this.props.users.filter(function (u) {
	              return u.id_role === 2;
	            }).map(function (u) {
	              return u.editorProfile;
	            }), dtStyle: 'dark' },
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'title', title: this.format({ id: 'name' }), sortable: true, md: 3, searchable: true }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'description', title: this.format({ id: 'description' }), md: 4, searchable: true, transform: this.transform.crop }),
	          _react2.default.createElement(_reactDatatableBootstrap.DataColumn, { field: 'validated_by', title: this.format({ id: 'validated' }), md: 2, transform: this.transform.lookUser }),
	...
	var _components = { default: EditorProfiles };
