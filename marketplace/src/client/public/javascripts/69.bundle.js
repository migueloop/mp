...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dashboard = function (_Components) {
	  _inherits(Dashboard, _Components);
	  ...
	  _createClass(Dashboard, [{
	    ...
	    value: function render() {
	      var iframeUrl = null;
	      var userRoleId = this.props.user.toJS().role.id;
	      ...
	      //   iframeUrl = 'https://sncf-bi360.digitaldimension.services/Dashboard?DashboardId=3';
	      // }
	      // const [Menu] = [MenuHorizontalCmpt].map(cmpt => cmpt.get(this.props.tenant));
	      // <div className="page-header">
	      //   <Menu align="right">
	      //     <Link to="/admin/dashboard/1" activeClassName="active" >
	      //       <FormattedMessage id="dashboard_number" values={{ dashboard_number: 1 }} />
	      //     </Link>
	      //     <Link to="/admin/dashboard/2" activeClassName="active" >
	      //       <FormattedMessage id="dashboard_number" values={{ dashboard_number: 2 }} />
	      //     </Link>
	      //     <Link to="/admin/dashboard/3" activeClassName="active" >
	      //       <FormattedMessage id="dashboard_number" values={{ dashboard_number: 3 }} />
	      //     </Link>
	      //     <Link to="/admin/dashboard/4" activeClassName="active" >
	      //       <FormattedMessage id="dashboard_number" values={{ dashboard_number: 4 }} />
	      //     </Link>
	      //   </Menu>
	      // </div>
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'page-body' },
	          iframeUrl && _react2.default.createElement('iframe', { style: { width: '100%', minHeight: '500px' }, src: iframeUrl })
	        )
	      );
	    }
	  }]);
