...
/***/ function(module, exports, __webpack_require__) {
	...
	var Assignments = function (_Components) {
	  ...
	  function Assignments() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Assignments.__proto__ || Object.getPrototypeOf(Assignments)).call.apply(_ref, [this].concat(args))), _this), _this.getMenu = function () {
	      var menuItems = [];
	      if (_this.props.user.get('permissions').toJS().includes(_constants.PERMISSIONS.CREATE_ASSIGNMENT.id)) {
	        menuItems.push({ url: '/admin/assignments/draft', title: _this.format({ id: 'awaiting_validation' }) });
	      }
	      menuItems.push({ url: '/admin/assignments/in-progress', title: _this.format({ id: 'delivery_in_progress' }), extraInfo: _this.format({ id: 'action_can_be_required' }) });
	      menuItems.push({ url: '/admin/assignments/done', title: _this.format({ id: 'done' }) });
	      return menuItems.map(function (data) {
	      ...
	      var canCreate = _this.props.user.toJS().permissions.indexOf(_constants.PERMISSIONS.CREATE_ASSIGNMENT.id) !== -1;
	      var createLink = _react2.default.createElement(
	        _reactRouter.Link,
	        { to: '/admin/assignment/new', className: 'btn btn-add pull-right', style: { zIndex: 100 } },
	        '+ ',
	        _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'assignment_create' })
	      );
	      return _react2.default.createElement(
	        ContentHeader,
	        { contentTitle: 'assignments' },
	  ...
	  _createClass(Assignments, [{
	    ...
	    value: function componentDidMount() {
	      Promise.all(Assignments.getActions(this.props.tenant, this.props.params, this.props.location.query, this.props.user).map(this.props.dispatch));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	    ...
	    value: function getActions(tenant) {
	      ...
	      return [actions.BackOffice.Assignments.fetch()];
	    }
	  }]);
