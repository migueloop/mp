...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Offers, [{
	    ...
	    value: function render() {
	      return (
	        ...
	        _react2.default.createElement('iframe', { src: 'http://intuiteev.knowledgeowl.com/help', className: 'billing-system-offers-bo' })
	      );
	    }
	  }]);
	...
	var _components = { default: (0, _reactRedux.connect)(stateToProps)(Offers) };
