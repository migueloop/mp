...
/***/ function(module, exports, __webpack_require__) {
	...
	var _caretRight = __webpack_require__(1458);
	...
	var _gdpDetails = __webpack_require__(1025);
	
	var _gdpDetails2 = _interopRequireDefault(_gdpDetails);
	...
	var Accordion = (_temp = _class = function (_Components) {
	  _inherits(Accordion, _Components);
	  ...
	  _createClass(Accordion, [{
	    ...
	    value: function render() {
	      ...
	      var _map = [_gdpDetails2.default].map(function (cmpt) {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'list-item-row list-item-row-collapsible ' + (this.state.open ? 'open' : 'closed') },
	        _react2.default.createElement(
	          _Row2.default,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _Button2.default,
	              { className: 'collapse-toggle', onClick: function onClick() {
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _Col2.default,
	              { xs: 2 },
	              _react2.default.createElement('img', { className: 'item-logo', src: itemInfo.product.logoUrl, alt: itemInfo.product.name })
	            ),
	            _react2.default.createElement(
	              _Col2.default,
	              { className: 'item-name', xs: 6 },
	              itemInfo.product.name
	            ),
	            _react2.default.createElement(
	              _Col2.default,
	              { className: 'item-name', xs: 2 },
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'type' }),
	              ': ',
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: itemInfo.product.type })
	            )
	          )
	        ),
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            _Row2.default,
	            null,
	            _react2.default.createElement(_Col2.default, { xs: 2 }),
	            _react2.default.createElement(_Col2.default, { className: 'item-actions', xs: 8 })
	          )
	        )
	      );
	    }
	  ...
	  itemInfo: _react2.default.PropTypes.object.isRequired
	}, _temp);
	...
	var _components = {
	  default: (0, _connect2.default)(stateToProps)(Accordion)
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GdpDetail = function (_Components) {
	  _inherits(GdpDetail, _Components);
	
	  function GdpDetail() {
	    _classCallCheck(this, GdpDetail);
	
	    return _possibleConstructorReturn(this, (GdpDetail.__proto__ || Object.getPrototypeOf(GdpDetail)).apply(this, arguments));
	  }
	
	  _createClass(GdpDetail, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      return _react2.default.createElement(
	        _Row2.default,
	        null,
	        Object.keys(this.props.details).reduce(function (values, key) {
	          var isArray = key.indexOf('[]') !== -1;
	          return values.concat([{
	            key: key.replace('[]', ''),
	            value: isArray ? _this2.props.details[key].map(function (id) {
	              return _this2.format({ id: id });
	            }).join(', ') : _this2.props.details[key]
	          }]);
	        }, []).map(function (item) {
	          return _react2.default.createElement(
	            _Col2.default,
	            ...
	            _react2.default.createElement(
	              'strong',
	              null,
	              _this2.format({ id: item.key })
	            ),
	            ': ',
	            _this2.format({ id: item.value || 'N/A' })
	          );
	        })
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _accordion = __webpack_require__(1024);
	...
	var AssignmentDetails = function (_Components) {
	  _inherits(AssignmentDetails, _Components);
	
	  function AssignmentDetails() {
	    _classCallCheck(this, AssignmentDetails);
	
	    return _possibleConstructorReturn(this, (AssignmentDetails.__proto__ || Object.getPrototypeOf(AssignmentDetails)).apply(this, arguments));
	  }
	
	  _createClass(AssignmentDetails, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	
	      if (!this.props.assignment.get('id')) {
	        return _react2.default.createElement(_reactSpinjs2.default, null);
	      }
	
	      var _map = [_accordion2.default].map(function (cmpt) {
	        return cmpt.get(_this2.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 1),
	          Accordion = _map2[0];
	      ...
	      return _react2.default.createElement(
	        'article',
	        { itemScope: true, itemType: 'http://schema.org/Product', className: 'mp-assignments' },
	        _react2.default.createElement(
	          'div',
	          { className: 'detail-assignment container' },
	          _react2.default.createElement(
	            'div',
	            { id: 'main-header' },
	            _react2.default.createElement(
	              'h2',
	              null,
	              _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'assignment_detail' })
	            )
	          ),
	          _react2.default.createElement(
	            _Row2.default,
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  { id: 'order-id' },
	                  '# ',
	                  this.props.assignment.get('idPoSystem'),
	                  ' '
	                ),
	                _react2.default.createElement(
	                  'p',
	                  { id: 'assigned-to' },
	                  this.props.assignment.get('assignedTo').get('firstName') + ' ' + this.props.assignment.get('assignedTo').get('lastName')
	                ),
	                _react2.default.createElement(
	                  'p',
	                  { id: 'creation-date' },
	                  this.props.assignment.get('assignedAt')
	                ),
	                _react2.default.createElement(
	                  'p',
	                  { id: 'assigned-by' },
	            ...
	            _react2.default.createElement(
	              ...
	              assignment.items.filter(function (item) {
	                ...
	                return _react2.default.createElement(
	                  'div',
	                  null,
	                  _react2.default.createElement(Accordion, { itemInfo: item })
	                );
	              })
	            )
	          )
	    ...
	    value: function getActions(tenant) {
	      ...
	      return [actions.BackOffice.Assignments.fetchOneExtra(params.id)];
	    }
	  }]);
