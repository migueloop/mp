...
/***/ function(module, exports, __webpack_require__) {
	...
	var _document = __webpack_require__(554);
	
	var _document2 = _interopRequireDefault(_document);
	
	var _image = __webpack_require__(557);
	
	var _image2 = _interopRequireDefault(_image);
	
	var _form = __webpack_require__(556);
	
	var _form2 = _interopRequireDefault(_form);
	
	var _video = __webpack_require__(558);
	...
	var _viewModels = __webpack_require__(559);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _foProductContactUs = __webpack_require__(555);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalEditResource = (_temp = _class = function (_Components) {
	  _inherits(ModalEditResource, _Components);
	
	  function ModalEditResource() {
	    _classCallCheck(this, ModalEditResource);
	
	    return _possibleConstructorReturn(this, (ModalEditResource.__proto__ || Object.getPrototypeOf(ModalEditResource)).apply(this, arguments));
	  }
	
	  _createClass(ModalEditResource, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      var resource = this.props.product.resources.find(function (r) {
	        return r.id === _this2.props.resource;
	      });
	      var image = '';
	      if (resource.type.startsWith(_constants.PRODUCT.RESOURCE.APPLICATION)) {
	        image = '/public/images/placeholders/Documents.png';
	      } else if (resource.type.startsWith(_constants.PRODUCT.RESOURCE.IMAGE)) {
	        image = '/public/uploads/products/' + this.props.product.id + '/' + resource.name;
	      } else if (resource.type.startsWith(_constants.PRODUCT.RESOURCE.VIDEO)) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          _Modal2.default.Body,
	          null,
	          _react2.default.createElement('img', { src: image, style: { maxHeight: 200, maxWidth: '100%', display: 'block', margin: '15px auto' }, alt: '' }),
	          _react2.default.createElement(
	            'label',
	            { style: { width: '100%' } },
	            _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'text', className: 'form-control', value: resource.name_custom,
	              onChange: function onChange(_ref) {
	                var value = _ref.target.value;
	                return _this2.props.update('name_custom')(value);
	              }
	            })
	          )
	        )
	  ...
	  resource: _react2.default.PropTypes.number,
	  update: _react2.default.PropTypes.func.isRequired
	}, _temp);
	
	
	var _components = { default: ModalEditResource };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modalEditResource = __webpack_require__(1120);
	
	var _modalEditResource2 = _interopRequireDefault(_modalEditResource);
	
	var _actions = __webpack_require__(41);
	
	var _actions2 = _interopRequireDefault(_actions);
	
	var _modalBase = __webpack_require__(529);
	...
	var Resources = (_temp = _class = function (_Components) {
	  ...
	  function Resources(props) {
	    ...
	    _this.onDrop = function (files) {
	      ...
	      new _actions2.default(_this.props.tenant).Products.AddResource(resource).then(function (action) {
	        return _this.props.dispatch(action);
	      });
	    };
	    ...
	    _this.deleteResource = function () {
	      var resource = _this.state.deleteResource;
	      var id = _this.props.product.toJS().id;
	      new _actions2.default(_this.props.tenant).Products.DeleteResource({ id: id, resource: resource }).then(function (action) {
	        return _this.props.dispatch(action);
	      });
	      _this.setState({ deleteResource: null });
	    };
	
	    _this.updateResource = function (field) {
	      return function (value) {
	        var resources = _this.props.product.toJS().resources.map(function (r) {
	          if (r.id != _this.state.editResource) {
	            return r;
	          }
	          if (_this.resourceTimeout) {
	            clearTimeout(_this.resourceTimeout);
	          }
	
	          _this.resourceTimeout = setTimeout(_this.context.save('resources'), 1000);
	
	          var obj = {};
	          obj[field] = value;
	          return _extends({}, r, obj);
	        });
	        //
	        _this.context.update('resources')(resources);
	      };
	    };
	  ...
	  _createClass(Resources, [{
	    ...
	    value: function componentDidMount() {
	      Promise.all(Resources.getActions(this.props.tenant, this.props.params, this.props.location.query, this.props.user).map(this.props.dispatch));
	    }
	  }, {
	    key: 'groupResources',
	    value: function groupResources(resources) {
	      ...
	      return resources.reduce(function (previous, current) {
	        if (current.type.startsWith(_constants.PRODUCT.RESOURCE.APPLICATION)) {
	          ...
	          return previous;
	        } else if (current.type.startsWith(_constants.PRODUCT.RESOURCE.IMAGE)) {
	          previous.Images.push(current);
	          return previous;
	        } else if (current.type.startsWith(_constants.PRODUCT.RESOURCE.VIDEO)) {
	    ...
	    key: 'showResources',
	    value: function showResources(resources, placeholder) {
	      var _this2 = this;
	
	      return resources.map(function (resource, index) {
	        var resourceHtml = _react2.default.createElement('img', { src: '', alt: '' });
	
	        if (resource.type.indexOf('image') == -1) {
	          resourceHtml = _react2.default.createElement('img', { src: placeholder, alt: resource.name_custom });
	        } else {
	          resourceHtml = _react2.default.createElement('div', { className: 'image-wrapper', style: { backgroundImage: 'url(/public/uploads/products/' + _this2.props.product.toJS().id + '/' + resource.name + ')' } });
	        }
	
	        return _react2.default.createElement(
	          _Col2.default,
	          { key: index, xs: 6, sm: 4, md: 3, lg: 3 },
	          _react2.default.createElement(
	            'div',
	            { className: 'thumbnail' },
	            _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  _Button2.default,
	                  { className: 'btn-view', onClick: _this2.openModal(resource) },
	                ...
	                _react2.default.createElement(
	                  ...
	                  { className: 'btn-edit',
	                    onClick: function onClick() {
	                      return _this2.setState({ editResource: resource.id });
	                    } },
	                  _react2.default.createElement(_reactIntl.FormattedMessage, {
	                    id: 'modify' })
	                ),
	                _react2.default.createElement(
	                  ...
	                  { className: 'btn-delete', onClick: function onClick() {
	                      _this2.setState({ deleteResource: resource });
	                    } },
	    ...
	    value: function render() {
	      ...
	      var _map = [_confirmationPopup2.default, _modalEditResource2.default].map(function (cmpt) {
	        return cmpt.get(_this3.props.tenant);
	      }),
	          _map2 = _slicedToArray(_map, 2),
	          ConfirmationPopup = _map2[0],
	          EditResourceModal = _map2[1];
	
	      var resources = this.groupResources(this.props.product.toJS().resources);
	      var sections = Object.keys(resources).map(function (sectionTitle, index) {
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'h3',
	                null,
	                _this3.format({ id: sectionTitle.toLowerCase() })
	              ),
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _Col2.default,
	              { xs: 12 },
	              _this3.showResources(resources[sectionTitle], placeholder)
	            )
	          )
	        );
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              { style: { width: 'auto', height: 'auto', border: 'none' }, onDrop: this.onDrop },
	              _react2.default.createElement(
	                _Button2.default,
	                { bsStyle: 'primary', style: { width: '100%', padding: 0 } },
	                _react2.default.createElement(_reactIntl.FormattedMessage, { id: 'add_resource' })
	              )
	            )
	          )
	        ),
	        sections,
	        _react2.default.createElement(_modalBase2.default, { show: this.state.showModal, onHide: function onHide() {
	            return _this3.setState({ showModal: false });
	          }, resourceSpecification: this.state.resource, type: this.state.modalType }),
	        _react2.default.createElement(
	          ConfirmationPopup,
	          { show: !!this.state.deleteResource, onHide: function onHide() {
	              return _this3.setState({ deleteResource: null });
	            }, onAction: this.deleteResource, actionStyle: 'danger', action: 'Delete', title: this.format({ id: 'confirmation' }) },
	          _react2.default.createElement(
	            'div',
	            null,
	        ...
	        _react2.default.createElement(EditResourceModal, _extends({ resource: this.state.editResource,
	          product: this.props.product.toJS(),
	          show: !!this.state.editResource,
	          hide: function hide() {
	            return _this3.setState({ editResource: null });
	          },
	...
	var _components = { default: Resources };
